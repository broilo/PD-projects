...
data_6,data_7 = np.loadtxt("Rhpp_DGM18cCTEQ6Lcut13v2.dat", usecols=(0,1), unpack=True)
data_8,data_9 = np.loadtxt("Rhpa_DGM18cCTEQ6Lcut13v2.dat", usecols=(0,1), unpack=True)

data_10,data_11 = np.loadtxt("Rhpp_DGM18cCT14cut13v2.dat", usecols=(0,1), unpack=True)
data_12,data_13 = np.loadtxt("Rhpa_DGM18cCT14cut13v2.dat", usecols=(0,1), unpack=True)

data_14,data_15 = np.loadtxt("Rhpp_DGM18cMMHTcut13v2.dat", usecols=(0,1), unpack=True)
data_16,data_17 = np.loadtxt("Rhpa_DGM18cMMHTcut13v2.dat", usecols=(0,1), unpack=True)
