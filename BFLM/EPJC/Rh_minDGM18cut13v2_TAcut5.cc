...
const int npRpp=68;
/********************************************************************************/
void Rh_minDGM18cut13v2_TAcut5()
{
...
//       c1->SetGrid();
    ...
    //configurações dos eixos x e y do gráfico (títulos, fontes, etc)      
     ...
     //lê e armazena curvas de Rho pp e pbarp calculadas com PDF CT14
      ...
      aq1 = fopen("Rhpp_DGM18cCT14cut13v2_TAcut5.dat","r"); 
      aq2 = fopen("Rhpa_DGM18cCT14cut13v2_TAcut5.dat","r");
      aq3 = fopen("Rhpp_DGM18cCTEQ6Lcut13v2_TAcut5.dat","r"); 
      aq4 = fopen("Rhpa_DGM18cCTEQ6Lcut13v2_TAcut5.dat","r");
      aq5 = fopen("Rhpp_DGM18cMMHTcut13v2_TAcut5.dat","r"); 
      aq6 = fopen("Rhpa_DGM18cMMHTcut13v2_TAcut5.dat","r");
...
//      leg2->SetFillColor(0);
    ...
    grRhoPBARP_CTEQ6L->Draw("csame"); 
      ...
      canv2->SaveAs("Rh_DGM18cut13v2_TAcut5.eps");    
      /********************************************************************************/
