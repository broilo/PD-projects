...
c
c Obs10: Inclui um termo do tipo Odderon na parte soft ímpar
c
c--------------------------------------------
...
double KerForward(double *x,double *par)
{
    ...
    /*******************************************************/
    double ReChiOddSoft=0.5*WOddS*D*(Cos(PiOver4())/Sqrt(s/s0)+E*Pi()*Y);  //MEXER NA PARTE QUE ENVOLVE O ODDERON     
    /*******************************************************/
    ...
    /*******************************************************/
    double ImChiOddSoft=-0.5*WOddS*D*Sin(PiOver4())/Sqrt(s/s0);  //MEXER NA PARTE QUE ENVOLVE O ODDERON
    /*******************************************************/    
...
// Plotting St data     
    ...
    grSigPBARP_CT14->Draw("csame");
      ...
      canv1->SaveAs("St_DGM19cCT14cut13_FFpresc_Odder.eps");    
//       canv1->Clear();
}
/*******************************************************************************/
...
//       c1->SetGrid();
    ...
    grRhoPBARP_CT14->Draw("csame");
      ...
      canv2->SaveAs("Rh_DGM19cCT14cut13_FFpresc_Odder.eps");      
      canv2->Clear();
}
/***********************************************************************************************************/
...
void DGM19cCT14cut13_FFpresc_Odder()
{
    /******************************************/
    //time control - start
    ...
    arglist[0] = 9.30; //fitting with CL = 1\sigma
    ...
    gMinuit->mnparm(6, "Nu1", vstart[6], step[5], 0,0,ierflg);
    gMinuit->mnparm(7, "Nu2", vstart[7], step[6], 0,0,ierflg);
...
/*************************************************************************************************/
   //calculates total xsection and rho, creating files to make the plots
    ...
    aq1=fopen("Stpp_DGM19cCT14cut13_FFpresc_Odder.dat","w"); 
    aq2=fopen("Rhpp_DGM19cCT14cut13_FFpresc_Odder.dat","w"); 
    aq3=fopen("Stpa_DGM19cCT14cut13_FFpresc_Odder.dat","w"); 
    aq4=fopen("Rhpa_DGM19cCT14cut13_FFpresc_Odder.dat","w");  
    ...
    double sigpp,rhopp,sigpbarp,rhopbarp;
     ...
     do{
      ...
      aq1 = fopen("Stpp_DGM19cCT14cut13_FFpresc_Odder.dat","r");
      aq2 = fopen("Rhpp_DGM19cCT14cut13_FFpresc_Odder.dat","r");
      aq3 = fopen("Stpa_DGM19cCT14cut13_FFpresc_Odder.dat","r");
      aq4 = fopen("Rhpa_DGM19cCT14cut13_FFpresc_Odder.dat","r");
