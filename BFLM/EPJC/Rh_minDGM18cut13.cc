...
//       c1->SetGrid();
    ...
    //configurações dos eixos x e y do gráfico (títulos, fontes, etc)      
     ...
     //Mateus: aqui vc deve substituir meus arquivos pelos seus resultados, lembrando de criar mais ponteiros do tipo "FILE" para ler os resultados da CTEQ e MMHT 
      aq1 = fopen("Rhpp_minDGM18cCT14lo.dat","r"); 
      aq2 = fopen("Rhpa_minDGM18cCT14lo.dat","r");
      aq3 = fopen("Rhpp_minDGM18cCTEQ6Llo.dat","r"); 
      aq4 = fopen("Rhpa_minDGM18cCTEQ6Llo.dat","r");
      aq5 = fopen("Rhpp_minDGM18cMMHTlo.dat","r"); 
      aq6 = fopen("Rhpa_minDGM18cMMHTlo.dat","r");
...
//      leg2->SetFillColor(0);
    ...
    grRhoPBARP_CTEQ6L->Draw("csame"); 
      ...
      canv2->SaveAs("Rh_minDGM18cut13.eps");    
      /********************************************************************************/
