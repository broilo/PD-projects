...
void St_minDGM18cut13v2_TAcut5()
{
    ...
    //lê e armazena curvas de SigTot pp e pbarp calculadas com PDF CT14
      ...
      aq2 = fopen("Stpa_DGM18cCT14cut13v2_TAcut5.dat","r");
      aq3 = fopen("Stpp_DGM18cCTEQ6Lcut13v2_TAcut5.dat","r"); 
      aq4 = fopen("Stpa_DGM18cCTEQ6Lcut13v2_TAcut5.dat","r");
      aq5 = fopen("Stpp_DGM18cMMHTcut13v2_TAcut5.dat","r"); 
      aq6 = fopen("Stpa_DGM18cMMHTcut13v2_TAcut5.dat","r");
...
//      leg1->AddEntry(grSigPBARP_CT14,"CT14LO - #bar{p}p","l");
    ...
    //cria arquivo .eps com o gráfico de saída
      ...
      canv1->SaveAs("St_DGM18cut13v2_TAcut5.eps"); 
    /********************************************************************************/
