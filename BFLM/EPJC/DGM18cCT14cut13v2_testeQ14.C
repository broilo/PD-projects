...
/*******************************************************************************/
const double b1=112.79;
const double b2=1.2177;
const double b3=0.61326;
const double b4=2.2886;
const double b5=-1034.8;
const double b6=0.58071e-1;
const double b7=1.3785;
const double b8=352.28;
const double b9=1.0957;
const double b10=0.13360;    
...
void PlotTotXSec(double *Wcm,double *sigtotPPCT14,double *sigtotPBARPCT14,int npfit)
{
    ...
    for(int i=0;i<npdpa;i++)     
     ...
     fclose(aq2);
      ...
      canv1->SaveAs("St_DGM18cCT14cut13v2_testeQ14.eps");    
//       canv1->Clear();
}
...
//       c1->SetGrid();
      ...
      canv2->SaveAs("Rh_DGM18cCT14cut13v2_testeQ14.eps");      
      canv2->Clear();
}
/***********************************************************************************************************/
...
void DGM18cCT14cut13v2_testeQ14()
{
...
//    gMinuit->mnexcm("MIGRAD", arglist ,1,ierflg);   
  ...
  cout << " Status of covariance matrix = " << icstat << "\n\n";  
   ...
   //calculates total xsection and rho, creating files to make the plots
    ...
    aq1=fopen("Stpp_DGM18cCT14cut13v2_testeQ14.dat","w"); 
    aq2=fopen("Rhpp_DGM18cCT14cut13v2_testeQ14.dat","w"); 
    aq3=fopen("Stpa_DGM18cCT14cut13v2_testeQ14.dat","w"); 
    aq4=fopen("Rhpa_DGM18cCT14cut13v2_testeQ14.dat","w");  
    ...
    double sigpp,rhopp,sigpbarp,rhopbarp;
     ...
     do{
      ...
      aq1 = fopen("Stpp_DGM18cCT14cut13v2_testeQ14.dat","r");
      aq2 = fopen("Rhpp_DGM18cCT14cut13v2_testeQ14.dat","r");
      aq3 = fopen("Stpa_DGM18cCT14cut13v2_testeQ14.dat","r");
      aq4 = fopen("Rhpa_DGM18cCT14cut13v2_testeQ14.dat","r");
