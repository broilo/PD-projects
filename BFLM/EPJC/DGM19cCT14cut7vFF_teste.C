...
double KerForward(double *x,double *par)
{
    ...
    /*******************************************************/
    TComplex ChiEvenSoft=0.5*WEvS*(A+(B*TComplex::Exp(TComplex::I()*PiOver4())/Sqrt(s/s0))+C*TComplex::Power((Y-TComplex::I()*PiOver2()),2));     
    /*******************************************************/
...
/*************************************************************************************************/
   //calculates total xsection and rho, creating files to make the plots
    ...
    aq1=fopen("Stpp_DGM19cCT14cut7vFF_teste.dat","w"); 
    aq2=fopen("Rhpp_DGM19cCT14cut7vFF_teste.dat","w"); 
    aq3=fopen("Stpa_DGM19cCT14cut7vFF_teste.dat","w"); 
    aq4=fopen("Rhpa_DGM19cCT14cut7vFF_teste.dat","w");  
    ...
    double sigpp,rhopp,sigpbarp,rhopbarp;
     ...
     do{
      ...
      aq2 = fopen("Rhpp_DGM19cCT14cut7vFF_teste.dat","r");
      aq3 = fopen("Stpa_DGM19cCT14cut7vFF_teste.dat","r");
      aq4 = fopen("Rhpa_DGM19cCT14cut7vFF_teste.dat","r");
