...
void xgVSx_Q10()
{
   ...
   //cria ponteiro do tipo TCanvas para desenhar o gráfico 
    ...
    //cria ponteiro do tipo TGraph para desenhar curvas 
      ...
      grCTEQ6L_Q10->SetLineWidth(1);
      grCTEQ6L_Q10->SetLineStyle(1);
      grCTEQ6L_Q10->Draw("c"); 
      
      TGraph *grCT14_Q10 = new TGraph(npfit,xx,CT14_Q10);
      grCT14_Q10->SetLineColor(4);
      grCT14_Q10->SetLineWidth(1);
      grCT14_Q10->SetLineStyle(3);
      grCT14_Q10->Draw("c");
      
      TGraph *grMMHT_Q10 = new TGraph(npfit,xx,MMHT_Q10);
      grMMHT_Q10->SetLineColor(2);
      grMMHT_Q10->SetLineWidth(1);
      grMMHT_Q10->SetLineStyle(2);
      grMMHT_Q10->Draw("c");

      grCTEQ6L_Q10->GetYaxis()->SetTitle("#bf{xg(x,Q^{2})}");
   ...
   latex_1->SetText(0.5,0.25,"#bf{Q^{2}= 10^{2} GeV^{2}}");
