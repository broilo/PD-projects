...
void PlotTotXSec(double *Wcm,double *sigtotPPMMHT,double *sigtotPBARPMMHT,int npfit)
{
    ...
    aq1 = fopen("paw_Stpa_Tcut5.dat","r");
    aq2 = fopen("paw_Stpp_Tcut5.dat","r");
    ...
    for(int i=0;i<npdpa;i++)     
     ...
     fclose(aq2);
      ...
      canv1->SaveAs("St_DGM18cMMHTcut13v2_Tcut5.eps");    
//       canv1->Clear();
}
...
void PlotRho(double *Wcm,double *rhoPPMMHT,double *rhoPBARPMMHT,int npfit)
{
  ...
  //Plotting rho data        
    aq1 = fopen("paw_Rhpa_Tcut5.dat","r");
    aq2 = fopen("paw_Rhpp_Tcut5.dat","r");
...
//       c1->SetGrid();
      ...
      canv2->SaveAs("Rh_DGM18cMMHTcut13v2_Tcut5.eps");      
      canv2->Clear();
}
/***********************************************************************************************************/
...
//    gMinuit->mnexcm("MIGRAD", arglist ,1,ierflg);   
  ...
  cout << " Status of covariance matrix = " << icstat << "\n\n";  
   ...
   //calculates total xsection and rho, creating files to make the plots
    ...
    aq1=fopen("Stpp_DGM18cMMHTcut13v2_Tcut5.dat","w"); 
    aq2=fopen("Rhpp_DGM18cMMHTcut13v2_Tcut5.dat","w"); 
    aq3=fopen("Stpa_DGM18cMMHTcut13v2_Tcut5.dat","w"); 
    aq4=fopen("Rhpa_DGM18cMMHTcut13v2_Tcut5.dat","w");  
    ...
    double sigpp,rhopp,sigpbarp,rhopbarp;
     ...
     do{
      ...
      aq1 = fopen("Stpp_DGM18cMMHTcut13v2_Tcut5.dat","r");
      aq2 = fopen("Rhpp_DGM18cMMHTcut13v2_Tcut5.dat","r");
      aq3 = fopen("Stpa_DGM18cMMHTcut13v2_Tcut5.dat","r");
      aq4 = fopen("Rhpa_DGM18cMMHTcut13v2_Tcut5.dat","r");
