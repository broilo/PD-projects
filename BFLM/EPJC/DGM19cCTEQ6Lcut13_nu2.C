...
// Plotting St data     
    ...
    grSigPBARP_CTEQ6L->Draw("csame");
      ...
      canv1->SaveAs("St_DGM19cCTEQ6Lcut13_nu2.eps");    
//       canv1->Clear();
}
/*******************************************************************************/
...
//       c1->SetGrid();
    ...
    grRhoPBARP_CTEQ6L->Draw("csame");
      ...
      canv2->SaveAs("Rh_DGM19cCTEQ6Lcut13_nu2.eps");      
      canv2->Clear();
}
/***********************************************************************************************************/
...
/*************************************************************************************************/
   //calculates total xsection and rho, creating files to make the plots
    ...
    aq1=fopen("Stpp_DGM19cCTEQ6Lcut13_nu2.dat","w"); 
    aq2=fopen("Rhpp_DGM19cCTEQ6Lcut13_nu2.dat","w"); 
    aq3=fopen("Stpa_DGM19cCTEQ6Lcut13_nu2.dat","w"); 
    aq4=fopen("Rhpa_DGM19cCTEQ6Lcut13_nu2.dat","w");  
    ...
    double sigpp,rhopp,sigpbarp,rhopbarp;
     ...
     do{
      ...
      aq1 = fopen("Stpp_DGM19cCTEQ6Lcut13_nu2.dat","r");
      aq2 = fopen("Rhpp_DGM19cCTEQ6Lcut13_nu2.dat","r");
      aq3 = fopen("Stpa_DGM19cCTEQ6Lcut13_nu2.dat","r");
      aq4 = fopen("Rhpa_DGM19cCTEQ6Lcut13_nu2.dat","r");
