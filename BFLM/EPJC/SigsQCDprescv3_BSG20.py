...
plt.text(20, 5300, '$Q_{min}=1.3$ GeV', fontdict=font)
plt.text(20, 4800, '$m_{g}=400$ MeV', fontdict=font)
########################################################################
#### Conjunto de dados
#
#plt.errorbar(x1,y1,yerr=ery1,fmt='k.',ecolor='k', capthick=1.8)
plt.errorbar(x2,y2,yerr=ery2,fmt='k.',ecolor='k', capthick=1.8, label="CT14 simulated points")
...
plt.plot(xf3,yf3, 'k-', linewidth=1.5, label=r'$Re\,\sigma_{PQCD}(s)$ Parametrized')
...
plt.savefig("SigsQCDprescv3_BSG20.eps")
#plt.show()
