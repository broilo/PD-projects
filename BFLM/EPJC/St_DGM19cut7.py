...
data_6,data_7 = np.loadtxt("Stpp_minDGM18cCTEQ6Llo_sStRh8e13.dat", usecols=(0,1), unpack=True)
data_8,data_9 = np.loadtxt("Stpa_minDGM18cCTEQ6Llo_sStRh8e13.dat", usecols=(0,1), unpack=True)

data_10,data_11 = np.loadtxt("Stpp_minDGM18cCT14lo_sStRh8e13.dat", usecols=(0,1), unpack=True)
data_12,data_13 = np.loadtxt("Stpa_minDGM18cCT14lo_sStRh8e13.dat", usecols=(0,1), unpack=True)

data_14,data_15 = np.loadtxt("Stpp_minDGM18cMMHTlo_sStRh8e13.dat", usecols=(0,1), unpack=True)
data_16,data_17 = np.loadtxt("Stpa_minDGM18cMMHTlo_sStRh8e13.dat", usecols=(0,1), unpack=True)
