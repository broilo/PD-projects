...
void St_DGM19cut13_C()
{
    ...
    //lê e armazena curvas de SigTot pp e pbarp calculadas com PDF CT14
      ...
      aq1 = fopen("Stpp_DGM19cCT14cut13_C.dat","r"); 
      aq2 = fopen("Stpa_DGM19cCT14cut13_C.dat","r");
      aq3 = fopen("Stpp_DGM19cCTEQ6Lcut13_C.dat","r"); 
      aq4 = fopen("Stpa_DGM19cCTEQ6Lcut13_C.dat","r");
      aq5 = fopen("Stpp_DGM19cMMHTcut13_C.dat","r"); 
      aq6 = fopen("Stpa_DGM19cMMHTcut13_C.dat","r");
    
      const int npfit=108; //esse é o número de pontos que eu calculei para a minha curva, caso vc tenha um número diferente, deves alterar.
...
//      leg1->AddEntry(grSigPBARP_CT14,"CT14LO - #bar{p}p","l");
    ...
    //cria arquivo .eps com o gráfico de saída
      ...
      canv1->SaveAs("St_DGM19cut13_C.eps"); 
    /********************************************************************************/
