...
void St_minDGM18cut8()
{
    ...
    //Mateus: aqui vc deve substituir meus arquivos pelos seus resultados, lembrando de criar mais ponteiros do tipo "FILE" para ler os resultados da CTEQ e MMHT 
      aq1 = fopen("Stpp_minDGM18cCT14lo_sStRh13.dat","r"); 
      aq2 = fopen("Stpa_minDGM18cCT14lo_sStRh13.dat","r");
      aq3 = fopen("Stpp_minDGM18cCTEQ6Llo_sStRh13.dat","r"); 
      aq4 = fopen("Stpa_minDGM18cCTEQ6Llo_sStRh13.dat","r");
      aq5 = fopen("Stpp_minDGM18cMMHTlo_sStRh13.dat","r"); 
      aq6 = fopen("Stpa_minDGM18cMMHTlo_sStRh13.dat","r");
