...
data_0,data_1,data_2 = np.loadtxt("paw_Stpp.dat", usecols=(0,1,2), unpack=True)

data_3,data_4,data_5 = np.loadtxt("paw_Stpa.dat", usecols=(0,1,2), unpack=True)

data_6,data_7 = np.loadtxt("Stpp_DGM18cCTEQ6Lcut13v2.dat", usecols=(0,1), unpack=True)
data_8,data_9 = np.loadtxt("Stpa_DGM18cCTEQ6Lcut13v2.dat", usecols=(0,1), unpack=True)

data_10,data_11 = np.loadtxt("Stpp_DGM18cCT14cut13v2.dat", usecols=(0,1), unpack=True)
data_12,data_13 = np.loadtxt("Stpa_DGM18cCT14cut13v2.dat", usecols=(0,1), unpack=True)

data_14,data_15 = np.loadtxt("Stpp_DGM18cMMHTcut13v2.dat", usecols=(0,1), unpack=True)
data_16,data_17 = np.loadtxt("Stpa_DGM18cMMHTcut13v2.dat", usecols=(0,1), unpack=True)
...
plt.xlim(9,20000)
plt.ylim(30,120)
plt.title(r"$\sqrt{s}=13$ TeV", fontdict=font)
