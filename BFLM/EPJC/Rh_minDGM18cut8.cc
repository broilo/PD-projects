...
//       c1->SetGrid();
    ...
    //configurações dos eixos x e y do gráfico (títulos, fontes, etc)      
     ...
     //Mateus: aqui vc deve substituir meus arquivos pelos seus resultados, lembrando de criar mais ponteiros do tipo "FILE" para ler os resultados da CTEQ e MMHT 
      aq1 = fopen("Rhpp_minDGM18cCT14lo_sStRh13.dat","r"); 
      aq2 = fopen("Rhpa_minDGM18cCT14lo_sStRh13.dat","r");
      aq3 = fopen("Rhpp_minDGM18cCTEQ6Llo_sStRh13.dat","r"); 
      aq4 = fopen("Rhpa_minDGM18cCTEQ6Llo_sStRh13.dat","r");
      aq5 = fopen("Rhpp_minDGM18cMMHTlo_sStRh13.dat","r"); 
      aq6 = fopen("Rhpa_minDGM18cMMHTlo_sStRh13.dat","r");
