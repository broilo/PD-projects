...
/*******************************************************************************/
const double b1=97.329;
const double b2=4.6693;
const double b3=0.18466;
const double b4=3.2789;
const double b5=-0.98462e-13;
const double b6=29.881;
const double b7=0.11099;
const double b8=-1.2775;
const double b9=-4.1382;
const double b10=-7.2237;  
...
void PlotTotXSec(double *Wcm,double *sigtotPPMMHT,double *sigtotPBARPMMHT,int npfit)
{
    ...
    for(int i=0;i<npdpa;i++)     
     ...
     fclose(aq2);
      ...
      canv1->SaveAs("St_DGM18cMMHTcut13v2_testeQ14.eps");    
//       canv1->Clear();
}
...
//       c1->SetGrid();
      ...
      canv2->SaveAs("Rh_DGM18cMMHTcut13v2_testeQ14.eps");      
      canv2->Clear();
}
/***********************************************************************************************************/
...
void DGM18cMMHTcut13v2_testeQ14()
{
...
//    gMinuit->mnexcm("MIGRAD", arglist ,1,ierflg);   
  ...
  cout << " Status of covariance matrix = " << icstat << "\n\n";  
   ...
   //calculates total xsection and rho, creating files to make the plots
    ...
    aq1=fopen("Stpp_DGM18cMMHTcut13v2_testeQ14.dat","w"); 
    aq2=fopen("Rhpp_DGM18cMMHTcut13v2_testeQ14.dat","w"); 
    aq3=fopen("Stpa_DGM18cMMHTcut13v2_testeQ14.dat","w"); 
    aq4=fopen("Rhpa_DGM18cMMHTcut13v2_testeQ14.dat","w");  
    ...
    double sigpp,rhopp,sigpbarp,rhopbarp;
     ...
     do{
      ...
      aq1 = fopen("Stpp_DGM18cMMHTcut13v2_testeQ14.dat","r");
      aq2 = fopen("Rhpp_DGM18cMMHTcut13v2_testeQ14.dat","r");
      aq3 = fopen("Stpa_DGM18cMMHTcut13v2_testeQ14.dat","r");
      aq4 = fopen("Rhpa_DGM18cMMHTcut13v2_testeQ14.dat","r");
