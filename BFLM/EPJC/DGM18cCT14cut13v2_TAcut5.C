...
void PlotTotXSec(double *Wcm,double *sigtotPPCT14,double *sigtotPBARPCT14,int npfit)
{
    ...
    for(int i=0;i<npdpa;i++)     
     ...
     fclose(aq2);
      ...
      canv1->SaveAs("St_DGM18cCT14cut13v2_TAcut5.eps");    
//       canv1->Clear();
}
...
//       c1->SetGrid();
      ...
      canv2->SaveAs("Rh_DGM18cCT14cut13v2_TAcut5.eps");      
      canv2->Clear();
}
/***********************************************************************************************************/
...
//    gMinuit->mnexcm("MIGRAD", arglist ,1,ierflg);   
  ...
  cout << " Status of covariance matrix = " << icstat << "\n\n";  
   ...
   //calculates total xsection and rho, creating files to make the plots
    ...
    aq1=fopen("Stpp_DGM18cCT14cut13v2_TAcut5.dat","w"); 
    aq2=fopen("Rhpp_DGM18cCT14cut13v2_TAcut5.dat","w"); 
    aq3=fopen("Stpa_DGM18cCT14cut13v2_TAcut5.dat","w"); 
    aq4=fopen("Rhpa_DGM18cCT14cut13v2_TAcut5.dat","w");  
    ...
    double sigpp,rhopp,sigpbarp,rhopbarp;
     ...
     do{
      ...
      aq1 = fopen("Stpp_DGM18cCT14cut13v2_TAcut5.dat","r");
      aq2 = fopen("Rhpp_DGM18cCT14cut13v2_TAcut5.dat","r");
      aq3 = fopen("Stpa_DGM18cCT14cut13v2_TAcut5.dat","r");
      aq4 = fopen("Rhpa_DGM18cCT14cut13v2_TAcut5.dat","r");
