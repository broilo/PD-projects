...
/*******************************************************************************/
const double b1=96.192;
const double b2=3.7065;
const double b3=0.19550;
const double b4=3.2443;
const double b5=-0.16757e-13;
const double b6=28.839;
const double b7=0.13147;
const double b8=0.43345e-2;
const double b9=0.99144;
const double b10=1.3230;  
...
void PlotTotXSec(double *Wcm,double *sigtotPPMMHT,double *sigtotPBARPMMHT,int npfit)
{
    ...
    for(int i=0;i<npdpa;i++)     
     ...
     fclose(aq2);
      ...
      canv1->SaveAs("St_DGM18cMMHTcut13v2_testeQ15.eps");    
//       canv1->Clear();
}
...
//       c1->SetGrid();
      ...
      canv2->SaveAs("Rh_DGM18cMMHTcut13v2_testeQ15.eps");      
      canv2->Clear();
}
/***********************************************************************************************************/
...
void DGM18cMMHTcut13v2_testeQ15()
{
...
//    gMinuit->mnexcm("MIGRAD", arglist ,1,ierflg);   
  ...
  cout << " Status of covariance matrix = " << icstat << "\n\n";  
   ...
   //calculates total xsection and rho, creating files to make the plots
    ...
    aq1=fopen("Stpp_DGM18cMMHTcut13v2_testeQ15.dat","w"); 
    aq2=fopen("Rhpp_DGM18cMMHTcut13v2_testeQ15.dat","w"); 
    aq3=fopen("Stpa_DGM18cMMHTcut13v2_testeQ15.dat","w"); 
    aq4=fopen("Rhpa_DGM18cMMHTcut13v2_testeQ15.dat","w");  
    ...
    double sigpp,rhopp,sigpbarp,rhopbarp;
     ...
     do{
      ...
      aq1 = fopen("Stpp_DGM18cMMHTcut13v2_testeQ15.dat","r");
      aq2 = fopen("Rhpp_DGM18cMMHTcut13v2_testeQ15.dat","r");
      aq3 = fopen("Stpa_DGM18cMMHTcut13v2_testeQ15.dat","r");
      aq4 = fopen("Rhpa_DGM18cMMHTcut13v2_testeQ15.dat","r");
