...
data_6,data_7 = np.loadtxt("Rhpp_minDGM18cCTEQ6Llo_sStRh8e13.dat", usecols=(0,1), unpack=True)
data_8,data_9 = np.loadtxt("Rhpa_minDGM18cCTEQ6Llo_sStRh8e13.dat", usecols=(0,1), unpack=True)

data_10,data_11 = np.loadtxt("Rhpp_minDGM18cCT14lo_sStRh8e13.dat", usecols=(0,1), unpack=True)
data_12,data_13 = np.loadtxt("Rhpa_minDGM18cCT14lo_sStRh8e13.dat", usecols=(0,1), unpack=True)

data_14,data_15 = np.loadtxt("Rhpp_minDGM18cMMHTlo_sStRh8e13.dat", usecols=(0,1), unpack=True)
data_16,data_17 = np.loadtxt("Rhpa_minDGM18cMMHTlo_sStRh8e13.dat", usecols=(0,1), unpack=True)
...
plt.xlim(9,20000)
plt.ylim(-0.3,0.3)
plt.title(r"$\sqrt{s}=7$ TeV", fontdict=font)
