/* DGM19cCT14cut7_FFpresc -> DGM19cCT14cut7_FFpresc
...
// Plotting St data     
    ...
    grSigPBARP_CT14->Draw("csame");
      ...
      canv1->SaveAs("St_DGM19cCT14cut7_FFpresc.eps");    
//       canv1->Clear();
}
/*******************************************************************************/
...
//       c1->SetGrid();
    ...
    grRhoPBARP_CT14->Draw("csame");
      ...
      canv2->SaveAs("Rh_DGM19cCT14cut7_FFpresc.eps");      
      canv2->Clear();
}
/***********************************************************************************************************/
...
/*************************************************************************************************/
   //calculates total xsection and rho, creating files to make the plots
    ...
    aq1=fopen("Stpp_DGM19cCT14cut7_FFpresc.dat","w"); 
    aq2=fopen("Rhpp_DGM19cCT14cut7_FFpresc.dat","w"); 
    aq3=fopen("Stpa_DGM19cCT14cut7_FFpresc.dat","w"); 
    aq4=fopen("Rhpa_DGM19cCT14cut7_FFpresc.dat","w");  
    ...
    double sigpp,rhopp,sigpbarp,rhopbarp;
     ...
     do{
      ...
      aq1 = fopen("Stpp_DGM19cCT14cut7_FFpresc.dat","r");
      aq2 = fopen("Rhpp_DGM19cCT14cut7_FFpresc.dat","r");
      aq3 = fopen("Stpa_DGM19cCT14cut7_FFpresc.dat","r");
      aq4 = fopen("Rhpa_DGM19cCT14cut7_FFpresc.dat","r");
