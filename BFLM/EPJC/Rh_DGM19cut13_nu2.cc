...
//       c1->SetGrid();
    ...
    //configurações dos eixos x e y do gráfico (títulos, fontes, etc)      
     ...
     //lê e armazena curvas de Rho pp e pbarp calculadas com PDF CT14
      ...
      aq1 = fopen("Rhpp_DGM19cCT14cut13_nu2.dat","r"); 
      aq2 = fopen("Rhpa_DGM19cCT14cut13_nu2.dat","r");
      aq3 = fopen("Rhpp_DGM19cCTEQ6Lcut13_nu2.dat","r"); 
      aq4 = fopen("Rhpa_DGM19cCTEQ6Lcut13_nu2.dat","r");
      aq5 = fopen("Rhpp_DGM19cMMHTcut13_nu2.dat","r"); 
      aq6 = fopen("Rhpa_DGM19cMMHTcut13_nu2.dat","r");
...
//      leg2->SetFillColor(0);
    ...
    grRhoPBARP_CTEQ6L->Draw("csame"); 
      ...
      canv2->SaveAs("Rh_DGM19cut13_nu2.eps");    
      /********************************************************************************/
