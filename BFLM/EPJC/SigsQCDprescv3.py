...
plt.text(20, 7000, 'Complex parametrization', fontdict=font)
...
plt.errorbar(x2,y2,yerr=ery2,fmt='b.',ecolor='b', capthick=1.8)
...
plt.plot(xf3,yf3, 'b-', linewidth=1.5, label=r'(CT14) $Re\,\sigma_{QCD}(s)$ Parametrized')
plt.plot(xf4,yf4, 'b--', linewidth=1.5, label=r'(CT14) $-Im\,\sigma_{QCD}(s)$ $s\to-is$')
