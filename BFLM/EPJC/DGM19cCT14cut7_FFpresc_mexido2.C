/* DGM19cCT14cut7_FFpresc -> DGM19cCT14cut7_FFpresc_mexido2
...
c
c OBS: Retirei Rh(7TeV) e mude a incerteza de Rh(8TeV) para ver se Rh(s) continua crescendo
c
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c
c Gera St e Rh
...
// Plotting St data     
    ...
    grSigPBARP_CT14->Draw("csame");
      ...
      canv1->SaveAs("St_DGM19cCT14cut7_FFpresc_mexido2.eps");    
//       canv1->Clear();
}
/*******************************************************************************/
...
//       c1->SetGrid();
    ...
    grRhoPBARP_CT14->Draw("csame");
      ...
      canv2->SaveAs("Rh_DGM19cCT14cut7_FFpresc_mexido2.eps");      
      canv2->Clear();
}
/***********************************************************************************************************/
...
{    
   /*******************************************************/ 
    ...
    //             
    aq1 = fopen("paw_Rhpa.dat","r");
    aq2 = fopen("paw_Rhppc10GeV_mexido2.dat","r");
...
void DGM19cCT14cut7_FFpresc_mexido2()
{
    /******************************************/
    //time control - start
...
/*************************************************************************************************/
   //calculates total xsection and rho, creating files to make the plots
    ...
    aq1=fopen("Stpp_DGM19cCT14cut7_FFpresc_mexido2.dat","w"); 
    aq2=fopen("Rhpp_DGM19cCT14cut7_FFpresc_mexido2.dat","w"); 
    aq3=fopen("Stpa_DGM19cCT14cut7_FFpresc_mexido2.dat","w"); 
    aq4=fopen("Rhpa_DGM19cCT14cut7_FFpresc_mexido2.dat","w");  
    ...
    double sigpp,rhopp,sigpbarp,rhopbarp;
     ...
     do{
      ...
      aq1 = fopen("Stpp_DGM19cCT14cut7_FFpresc_mexido2.dat","r");
      aq2 = fopen("Rhpp_DGM19cCT14cut7_FFpresc_mexido2.dat","r");
      aq3 = fopen("Stpa_DGM19cCT14cut7_FFpresc_mexido2.dat","r");
      aq4 = fopen("Rhpa_DGM19cCT14cut7_FFpresc_mexido2.dat","r");
