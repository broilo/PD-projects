...
/*******************************************************************************/
const double b1=98.493;
const double b2=0.31392;
const double b3=0.89353;
const double b4=2.1110;
const double b5=-0.20490e-15;
const double b6=35.453;
const double b7=0.14895;
const double b8=0.21507e-1;
const double b9=3.7354;
const double b10=0.88469;   
...
void PlotTotXSec(double *Wcm,double *sigtotPPCTEQ6L,double *sigtotPBARPCTEQ6L,int npfit)
{
    ...
    for(int i=0;i<npdpa;i++)     
     ...
     fclose(aq2);
      ...
      canv1->SaveAs("St_DGM18cCTEQ6Lcut13v2_testeQ14.eps");    
//       canv1->Clear();
}
...
//       c1->SetGrid();
      ...
      canv2->SaveAs("Rh_DGM18cCTEQ6Lcut13v2_testeQ14.eps");      
      canv2->Clear();
}
/***********************************************************************************************************/
...
void DGM18cCTEQ6Lcut13v2_testeQ14()
{
...
//    gMinuit->mnexcm("MIGRAD", arglist ,1,ierflg);   
  ...
  cout << " Status of covariance matrix = " << icstat << "\n\n";  
   ...
   //calculates total xsection and rho, creating files to make the plots
    ...
    aq1=fopen("Stpp_DGM18cCTEQ6Lcut13v2_testeQ14.dat","w"); 
    aq2=fopen("Rhpp_DGM18cCTEQ6Lcut13v2_testeQ14.dat","w"); 
    aq3=fopen("Stpa_DGM18cCTEQ6Lcut13v2_testeQ14.dat","w"); 
    aq4=fopen("Rhpa_DGM18cCTEQ6Lcut13v2_testeQ14.dat","w");  
    ...
    double sigpp,rhopp,sigpbarp,rhopbarp;
     ...
     do{
      ...
      aq1 = fopen("Stpp_DGM18cCTEQ6Lcut13v2_testeQ14.dat","r");
      aq2 = fopen("Rhpp_DGM18cCTEQ6Lcut13v2_testeQ14.dat","r");
      aq3 = fopen("Stpa_DGM18cCTEQ6Lcut13v2_testeQ14.dat","r");
      aq4 = fopen("Rhpa_DGM18cCTEQ6Lcut13v2_testeQ14.dat","r");
