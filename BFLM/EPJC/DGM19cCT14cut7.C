...
// Plotting St data     
    ...
    grSigPBARP_CT14->Draw("csame");
      ...
      canv1->SaveAs("St_DGM19cCT14cut7.eps");    
//       canv1->Clear();
}
/*******************************************************************************/
...
//       c1->SetGrid();
    ...
    grRhoPBARP_CT14->Draw("csame");
      ...
      canv2->SaveAs("Rh_DGM19cCT14cut7.eps");      
      canv2->Clear();
}
/***********************************************************************************************************/
...
//    gMinuit->mnexcm("MIGRAD", arglist ,1,ierflg);   
  ...
  cout << " Status of covariance matrix = " << icstat << "\n\n";  
   ...
   //calculates total xsection and rho, creating files to make the plots
    ...
    aq1=fopen("Stpp_DGM19cCT14cut7.dat","w"); 
    aq2=fopen("Rhpp_DGM19cCT14cut7.dat","w"); 
    aq3=fopen("Stpa_DGM19cCT14cut7.dat","w"); 
    aq4=fopen("Rhpa_DGM19cCT14cut7.dat","w");  
    ...
    double sigpp,rhopp,sigpbarp,rhopbarp;
     ...
     do{
      ...
      aq1 = fopen("Stpp_DGM19cCT14cut7.dat","r");
      aq2 = fopen("Rhpp_DGM19cCT14cut7.dat","r");
      aq3 = fopen("Stpa_DGM19cCT14cut7.dat","r");
      aq4 = fopen("Rhpa_DGM19cCT14cut7.dat","r");
