...
void St_DGM19cut13_nu2()
{
    ...
    //lê e armazena curvas de SigTot pp e pbarp calculadas com PDF CT14
      ...
      aq2 = fopen("Stpa_DGM19cCT14cut13_nu2.dat","r");
      aq3 = fopen("Stpp_DGM19cCTEQ6Lcut13_nu2.dat","r"); 
      aq4 = fopen("Stpa_DGM19cCTEQ6Lcut13_nu2.dat","r");
      aq5 = fopen("Stpp_DGM19cMMHTcut13_nu2.dat","r"); 
      aq6 = fopen("Stpa_DGM19cMMHTcut13_nu2.dat","r");
...
//      leg1->AddEntry(grSigPBARP_CT14,"CT14LO - #bar{p}p","l");
    ...
    //cria arquivo .eps com o gráfico de saída
      ...
      canv1->SaveAs("St_DGM19cut13_nu2.eps"); 
    /********************************************************************************/
