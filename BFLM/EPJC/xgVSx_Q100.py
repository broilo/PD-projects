...
data_0,data_1 = np.loadtxt("xgVSx_CTEQ6L_Q100.dat", usecols=(0,1), unpack=True)
data_2,data_3 = np.loadtxt("xgVSx_CT14_Q100.dat", usecols=(0,1), unpack=True)
data_4,data_5 = np.loadtxt("xgVSx_MMHT_Q100.dat", usecols=(0,1), unpack=True)
...
plt.title('$Q=100$ GeV', fontdict=font)
