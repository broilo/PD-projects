...
// Plotting St data     
    ...
    gr_cosmics->Draw("pz");
    grSigPP_MMHT->Draw("csame"); 
    grSigPBARP_MMHT->Draw("csame");
      
      canv1->SaveAs("St_DGM19cMMHTcut13_sATLAS.eps");    
//       canv1->Clear();
}
/*******************************************************************************/
...
//       c1->SetGrid();
    ...
    grRhoPP_MMHT->Draw("csame");
    grRhoPBARP_MMHT->Draw("csame");
           
      canv2->SaveAs("Rh_DGM19cMMHTcut13_sATLAS.eps");      
      canv2->Clear();
}
/***********************************************************************************************************/
...
/*************************************************************************************************/
   //calculates total xsection and rho, creating files to make the plots
    ...
    aq1=fopen("Stpp_DGM19cMMHTcut13_sATLAS.dat","w"); 
    aq2=fopen("Rhpp_DGM19cMMHTcut13_sATLAS.dat","w"); 
    aq3=fopen("Stpa_DGM19cMMHTcut13_sATLAS.dat","w"); 
    aq4=fopen("Rhpa_DGM19cMMHTcut13_sATLAS.dat","w");  
    ...
    double sigpp,rhopp,sigpbarp,rhopbarp;
     ...
     do{
      ...
      aq1 = fopen("Stpp_DGM19cMMHTcut13_sATLAS.dat","r");
      aq2 = fopen("Rhpp_DGM19cMMHTcut13_sATLAS.dat","r");
      aq3 = fopen("Stpa_DGM19cMMHTcut13_sATLAS.dat","r");
      aq4 = fopen("Rhpa_DGM19cMMHTcut13_sATLAS.dat","r");
