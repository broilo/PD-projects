/* DGM19cCT14cut7_FFpresc_TESTE -> DGM19cCT14cut7_FFpresc_TESTE
...
// Plotting St data     
    ...
    grSigPBARP_CT14->Draw("csame");
      ...
      canv1->SaveAs("St_DGM19cCT14cut7_FFpresc_TESTE.eps");    
//       canv1->Clear();
}
/*******************************************************************************/
...
//       c1->SetGrid();
    ...
    grRhoPBARP_CT14->Draw("csame");
      ...
      canv2->SaveAs("Rh_DGM19cCT14cut7_FFpresc_TESTE.eps");      
      canv2->Clear();
}
/***********************************************************************************************************/
...
void DGM19cCT14cut7_FFpresc_TESTE()
{
    /******************************************/
    //time control - start
...
/*************************************************************************************************/
   //calculates total xsection and rho, creating files to make the plots
    ...
    aq1=fopen("Stpp_DGM19cCT14cut7_FFpresc_TESTE.dat","w"); 
    aq2=fopen("Rhpp_DGM19cCT14cut7_FFpresc_TESTE.dat","w"); 
    aq3=fopen("Stpa_DGM19cCT14cut7_FFpresc_TESTE.dat","w"); 
    aq4=fopen("Rhpa_DGM19cCT14cut7_FFpresc_TESTE.dat","w");  
    ...
    double sigpp,rhopp,sigpbarp,rhopbarp;
     ...
     do{
      ...
      aq1 = fopen("Stpp_DGM19cCT14cut7_FFpresc_TESTE.dat","r");
      aq2 = fopen("Rhpp_DGM19cCT14cut7_FFpresc_TESTE.dat","r");
      aq3 = fopen("Stpa_DGM19cCT14cut7_FFpresc_TESTE.dat","r");
      aq4 = fopen("Rhpa_DGM19cCT14cut7_FFpresc_TESTE.dat","r");
