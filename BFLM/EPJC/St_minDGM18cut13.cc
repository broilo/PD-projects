...
void St_minDGM18cut13()
{
    ...
    //Mateus: aqui vc deve substituir meus arquivos pelos seus resultados, lembrando de criar mais ponteiros do tipo "FILE" para ler os resultados da CTEQ e MMHT 
      aq1 = fopen("Stpp_minDGM18cCT14lo.dat","r"); 
      aq2 = fopen("Stpa_minDGM18cCT14lo.dat","r");
      aq3 = fopen("Stpp_minDGM18cCTEQ6Llo.dat","r"); 
      aq4 = fopen("Stpa_minDGM18cCTEQ6Llo.dat","r");
      aq5 = fopen("Stpp_minDGM18cMMHTlo.dat","r"); 
      aq6 = fopen("Stpa_minDGM18cMMHTlo.dat","r");
...
//      leg1->AddEntry(grSigPBARP_CT14,"CT14LO - #bar{p}p","l");
    ...
    //cria arquivo .eps com o gráfico de saída
      ...
      canv1->SaveAs("St_minDGM18cut13.eps"); 
    /********************************************************************************/
