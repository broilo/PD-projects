...
------------------------------------------------------------------------
 ...
 root -l -q /usr/lib/x86_64-linux-gnu/libgsl.so /usr/lib/x86_64-linux-gnu/libgslcblas.so BSG20orig_band2str2_V002.C | cat > BSG20orig_band2str2_V002.min
...
/* ---> desenhando um miniframe em um pad dentro do canvas canv1 <--- */
    ...
    grSigPP_Eik->Draw("csame");
      ...
      canv1->SaveAs("St_BSG20orig_band2str2_V002.eps");    
}
//----------------------------------------------------------------------
...
void BSG20orig_band2str2_V002()
{
    ...
    arglist[0] = 3.53; // --> número qualaquer //fitting with CL = 1\sigma
    gMinuit->mnexcm("SET ERR",arglist,1,ierflg); 
      
    double vstart[numpar] = {77.0,35.0,70.0};  
/*    
    ...
    double B=0.68;//outpar[6]
{
    ...
    0.585,
    1.5}; //start values */
    double step[numpar] = {1.e-3,1.e-3,1.e-3}; //steps
...
//----------------------------------------------------------------------
   //calculates total xsection and rho, creating files to make the plots
    ...
    aq1=fopen("Stpp_BSG20orig_band2str2_V002.dat","w"); 
    aq2=fopen("Stpbp_BSG20orig_band2str2_V002.dat","w"); 
    ...
    double sigpp,sigpbarp;
     ...
     do{
      ...
      aq1 = fopen("Stpp_BSG20orig_band2str2_V002.dat","r");
      aq2 = fopen("Stpbp_BSG20orig_band2str2_V002.dat","r");
