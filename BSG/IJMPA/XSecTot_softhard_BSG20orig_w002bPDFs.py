...
px1,py1 = np.loadtxt("XSecTotPPsoft_BSG20orig_w002b_changes_CT14_F77.dat", usecols=(0,1), unpack=True)

px2,py2 = np.loadtxt("XSecTotPBPsoft_BSG20orig_w002b_changes_CT14_F77.dat", usecols=(0,1), unpack=True)

px3,py3 = np.loadtxt("XSecTotPP_BSG20orig_w002b_CTEQ6L.dat", usecols=(0,1), unpack=True)

px4,py4 = np.loadtxt("XSecTotPBP_BSG20orig_w002b_CTEQ6L.dat", usecols=(0,1), unpack=True)
...
plt.savefig("XSecTot_softhard_BSG20orig_w002bPDFs.eps")
plt.show()
