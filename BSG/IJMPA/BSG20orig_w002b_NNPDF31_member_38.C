...
------------------------------------------------------------------------
 ...
 root -l -q /usr/lib/x86_64-linux-gnu/libgsl.so /usr/lib/x86_64-linux-gnu/libgslcblas.so BSG20orig_w002b_NNPDF31_member_38.C | cat > BSG20orig_w002b_NNPDF31_member_38.min
 
  NNPDF31_member_38 -> See: https://lhapdf.hepforge.org/index.html
   ---------------------------------------------------------------------
...
//----------------------------------------------------------------------
//QCD cross section - analytical parametrization for NNPDF31_member_38
//----------------------------------------------------------------------
...
const double b1=1.17226e+02;
const double b2=6.91032e-04;
const double b3=3.55312e+00;
const double b4=1.24664e+00;
const double b5=-3.33012e+00;
const double b6=2.01166e+00;
const double b7=8.04093e-01;
const double b8=3.85171e+00;
const double b9=1.30275e+00;
const double b10=1.25045e+00; 
/*
 NO.   NAME      VALUE            ERROR          SIZE      DERIVATIVE 
   1  b1           1.17226e+02   6.53719e-01  -2.37170e-02  -1.64724e+00
   2  b2           6.91032e-04   3.58725e-05  -4.80052e-06  -3.54473e+04
   3  b3           3.55312e+00   7.90774e-04   6.34012e-05  -1.21740e+02
   4  b4           1.24664e+00   3.18424e-03   1.09759e-03  -5.98150e+02
   5  b5          -3.33012e+00   3.57772e-02  -1.16515e-02  -2.71417e+01
   6  b6           2.01166e+00   3.80318e-03  -2.33160e-03   2.11631e+02
   7  b7           8.04093e-01   7.30301e-03  -3.58128e-03   4.63974e+02
   8  b8           3.85171e+00   3.09863e-02  -2.52334e-03  -4.61617e+01
   9  b9           1.30275e+00   2.31832e-03  -6.29730e-04  -6.99579e+02
  10  b10          1.25045e+00   2.85581e-03  -1.73993e-03  -9.82343e+02
*/
//----------------------------------------------------------------------
/*
                              Analysis 
...
/* ---> desenhando um miniframe em um pad dentro do canvas canv1 <--- */
    ...
    grSigTotPP->Draw("csame");
      ...
      canv1->SaveAs("XSECtot_BSG20orig_w002b_NNPDF31_member_38.eps");    
}
//----------------------------------------------------------------------
...
/* ---> desenhando um miniframe em um pad dentro do canvas canv1 <--- */
    ...
    grSigElPP->Draw("csame");
      ...
      canv1->SaveAs("XSECel_BSG20orig_w002b_NNPDF31_member_38.eps");    
}
//----------------------------------------------------------------------
...
// Plotting SigDiff data    
    ...
    for(int i=0;i<NPaq3;i++)     
     ...
     fclose(aq8);
      ...
      canv1->SaveAs("XSECdiff_BSG20orig_w002b_NNPDF31_member_38.eps");
}
//----------------------------------------------------------------------
...
{   
      ...
      canv1->SaveAs("XSECeik_BSG20orig_w002b_NNPDF31_member_38.eps");    
}
...
{   
      ...
      canv1->SaveAs("XSECsofthard_BSG20orig_w002b_NNPDF31_member_38.eps");    
}
...
//----------------------------------------------------------------------
void BSG20orig_w002b_NNPDF31_member_38()
{
    /******************************************/
    //time control - start
...
/*
 FCN=497.524 FROM MIGRAD    STATUS=CONVERGED      13 CALLS         361 TOTAL
                     EDM=4.71652e-13    STRATEGY= 1  ERROR MATRIX UNCERTAINTY   0.0 per cent
  EXT PARAMETER                                   STEP         FIRST   
  NO.   NAME      VALUE            ERROR          SIZE      DERIVATIVE 
   1  w            1.41840e+00   9.60167e-02   0.00000e+00   1.10597e-05
   2  Sig0         8.34410e+01   1.99915e+00   0.00000e+00  -1.29535e-06
   3  A1           2.77244e+01   2.21405e+00  -0.00000e+00  -4.92548e-09
   4  del1         1.25400e+00   9.52175e-02   0.00000e+00  -1.82949e-05
   5  A2           2.27862e+01   1.55881e+00  -0.00000e+00   6.77818e-07
   6  del2         5.79785e-01   4.46784e-02  -0.00000e+00   3.62134e-05
                               ERR DEF= 7.04
*/
...
//----------------------------------------------------------------------
   //calculates total, elastic, diff and eik xsection, creating files to make the plots
    ...
    aq1=fopen("XSecTotPP_BSG20orig_w002b_NNPDF31_member_38.dat","w"); 
    aq2=fopen("XSecTotPBP_BSG20orig_w002b_NNPDF31_member_38.dat","w");
    aq3=fopen("XSecElPP_BSG20orig_w002b_NNPDF31_member_38.dat","w"); 
    aq4=fopen("XSecElPBP_BSG20orig_w002b_NNPDF31_member_38.dat","w");
    aq5=fopen("XSecDiffPP_BSG20orig_w002b_NNPDF31_member_38.dat","w"); 
    aq6=fopen("XSecDiffPBP_BSG20orig_w002b_NNPDF31_member_38.dat","w");  
    aq7=fopen("XSecEikPP_BSG20orig_w002b_NNPDF31_member_38.dat","w"); 
    aq8=fopen("XSecEikPBP_BSG20orig_w002b_NNPDF31_member_38.dat","w"); 
    aq9=fopen("XSecSoftPP_BSG20orig_w002b_NNPDF31_member_38.dat","w"); 
    aq10=fopen("XSecSoftPBP_BSG20orig_w002b_NNPDF31_member_38.dat","w");             
    aq11=fopen("XSecHard_BSG20orig_w002b_NNPDF31_member_38.dat","w"); 
    ...
    double Stpp,Stpbarp,Selpp,Selpbarp,Sdiffpp,Sdiffpbarp,Seikpp,Seikpbarp,Ssoftpp,Ssoftpbarp,Shard;
     ...
     do{
      ...
      aq1 = fopen("XSecTotPP_BSG20orig_w002b_NNPDF31_member_38.dat","r");
      aq2 = fopen("XSecTotPBP_BSG20orig_w002b_NNPDF31_member_38.dat","r");
      aq3 = fopen("XSecElPP_BSG20orig_w002b_NNPDF31_member_38.dat","r");
      aq4 = fopen("XSecElPBP_BSG20orig_w002b_NNPDF31_member_38.dat","r");
      aq5 = fopen("XSecDiffPP_BSG20orig_w002b_NNPDF31_member_38.dat","r"); 
      aq6 = fopen("XSecDiffPBP_BSG20orig_w002b_NNPDF31_member_38.dat","r");  
      aq7 = fopen("XSecEikPP_BSG20orig_w002b_NNPDF31_member_38.dat","r"); 
      aq8 = fopen("XSecEikPBP_BSG20orig_w002b_NNPDF31_member_38.dat","r"); 
      aq9 = fopen("XSecSoftPP_BSG20orig_w002b_NNPDF31_member_38.dat","r"); 
      aq10 = fopen("XSecSoftPBP_BSG20orig_w002b_NNPDF31_member_38.dat","r");             
      aq11 = fopen("XSecHard_BSG20orig_w002b_NNPDF31_member_38.dat","r");                   
