...
px1,py1 = np.loadtxt("XSecTotPP_BSG20orig_w002b_F77.dat", usecols=(0,1), unpack=True)

px2,py2 = np.loadtxt("XSecTotPBP_BSG20orig_w002b_F77.dat", usecols=(0,1), unpack=True)
...
plt.savefig("XSecTot_BSG20orig_w002b_F77.eps")
#plt.show()
