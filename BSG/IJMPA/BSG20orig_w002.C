...
------------------------------------------------------------------------
 ...
 root -l -q /usr/lib/x86_64-linux-gnu/libgsl.so /usr/lib/x86_64-linux-gnu/libgslcblas.so BSG20orig_w002.C | cat > BSG20orig_w002.min
   ...
   Last update: 13/mar/2020 (Pelotas, RS, Brazil)
...
/* ---> desenhando um miniframe em um pad dentro do canvas canv1 <--- */
    ...
    grSigTotPP->Draw("csame");
      ...
      canv1->SaveAs("XSECtot_BSG20orig_w002.eps");    
}
//----------------------------------------------------------------------
...
/* ---> desenhando um miniframe em um pad dentro do canvas canv1 <--- */
    ...
    grSigElPP->Draw("csame");
      ...
      canv1->SaveAs("XSECel_BSG20orig_w002.eps");    
}
//----------------------------------------------------------------------
...
// Plotting SigDiff data    
    ...
    for(int i=0;i<NPaq3;i++)     
     ...
     fclose(aq8);
      ...
      canv1->SaveAs("XSECdiff_BSG20orig_w002.eps");
}
//----------------------------------------------------------------------
...
{   
      ...
      canv1->SaveAs("XSECeik_BSG20orig_w002.eps");    
}
//----------------------------------------------------------------------
...
void BSG20orig_w002()
{
    ...
    arglist[0] = 8.18; // --> número qualaquer //fitting with CL = 1\sigma
    ...
    double vstart[numpar] = 
{
    ...
    gMinuit->mnparm(6, "B",    vstart[6],   step[6], 0,0,ierflg);
...
//----------------------------------------------------------------------
   //calculates total, elastic, diff and eik xsection, creating files to make the plots
    ...
    aq1=fopen("XSecTotPP_BSG20orig_w002.dat","w"); 
    aq2=fopen("XSecTotPBP_BSG20orig_w002.dat","w");
    aq3=fopen("XSecElPP_BSG20orig_w002.dat","w"); 
    aq4=fopen("XSecElPBP_BSG20orig_w002.dat","w");
    aq5=fopen("XSecDiffPP_BSG20orig_w002.dat","w"); 
    aq6=fopen("XSecDiffPBP_BSG20orig_w002.dat","w");  
    aq7=fopen("XSecEikPP_BSG20orig_w002.dat","w"); 
    aq8=fopen("XSecEikPBP_BSG20orig_w002.dat","w");      
    ...
    double Stpp,Stpbarp,Selpp,Selpbarp,Sdiffpp,Sdiffpbarp,Seikpp,Seikpbarp;
     ...
     do{
      ...
      aq1 = fopen("XSecTotPP_BSG20orig_w002.dat","r");
      aq2 = fopen("XSecTotPBP_BSG20orig_w002.dat","r");
      aq3 = fopen("XSecElPP_BSG20orig_w002.dat","r");
      aq4 = fopen("XSecElPBP_BSG20orig_w002.dat","r");
      aq5 = fopen("XSecDiffPP_BSG20orig_w002.dat","r"); 
      aq6 = fopen("XSecDiffPBP_BSG20orig_w002.dat","r");  
      aq7 = fopen("XSecEikPP_BSG20orig_w002.dat","r"); 
      aq8 = fopen("XSecEikPBP_BSG20orig_w002.dat","r");                    
