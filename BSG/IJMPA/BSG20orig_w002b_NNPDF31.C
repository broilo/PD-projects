...
------------------------------------------------------------------------
 ...
 root -l -q /usr/lib/x86_64-linux-gnu/libgsl.so /usr/lib/x86_64-linux-gnu/libgslcblas.so BSG20orig_w002b_NNPDF31.C | cat > BSG20orig_w002b_NNPDF31.min
 
  NNPDF31 -> See: https://lhapdf.hepforge.org/index.html
   ---------------------------------------------------------------------
...
//----------------------------------------------------------------------
//QCD cross section - analytical parametrization for NNPDF31
//----------------------------------------------------------------------
...
const double b1=9.65538e+01;
const double b2=6.30529e-02;
const double b3=7.99588e-01;
const double b4=2.25350e+00;
const double b5=-1.47520e+00;
const double b6=5.69277e-01;
const double b7=-4.68107e-01;
const double b8=3.25789e-01;
const double b9=1.07119e+00;
const double b10=1.72692e+00; 
//----------------------------------------------------------------------
/*
                              Analysis 
*/
...
/* ---> desenhando um miniframe em um pad dentro do canvas canv1 <--- */
    ...
    grSigTotPP->Draw("csame");
      ...
      canv1->SaveAs("XSECtot_BSG20orig_w002b_NNPDF31.eps");    
}
//----------------------------------------------------------------------
...
/* ---> desenhando um miniframe em um pad dentro do canvas canv1 <--- */
    ...
    grSigElPP->Draw("csame");
      ...
      canv1->SaveAs("XSECel_BSG20orig_w002b_NNPDF31.eps");    
}
//----------------------------------------------------------------------
...
// Plotting SigDiff data    
    ...
    for(int i=0;i<NPaq3;i++)     
     ...
     fclose(aq8);
      ...
      canv1->SaveAs("XSECdiff_BSG20orig_w002b_NNPDF31.eps");
}
//----------------------------------------------------------------------
...
{   
      ...
      canv1->SaveAs("XSECeik_BSG20orig_w002b_NNPDF31.eps");    
}
...
{   
      ...
      canv1->SaveAs("XSECsofthard_BSG20orig_w002b_NNPDF31.eps");    
}
...
//----------------------------------------------------------------------
   //calculates total, elastic, diff and eik xsection, creating files to make the plots
    ...
    aq1=fopen("XSecTotPP_BSG20orig_w002b_NNPDF31.dat","w"); 
    aq2=fopen("XSecTotPBP_BSG20orig_w002b_NNPDF31.dat","w");
    aq3=fopen("XSecElPP_BSG20orig_w002b_NNPDF31.dat","w"); 
    aq4=fopen("XSecElPBP_BSG20orig_w002b_NNPDF31.dat","w");
    aq5=fopen("XSecDiffPP_BSG20orig_w002b_NNPDF31.dat","w"); 
    aq6=fopen("XSecDiffPBP_BSG20orig_w002b_NNPDF31.dat","w");  
    aq7=fopen("XSecEikPP_BSG20orig_w002b_NNPDF31.dat","w"); 
    aq8=fopen("XSecEikPBP_BSG20orig_w002b_NNPDF31.dat","w"); 
    aq9=fopen("XSecSoftPP_BSG20orig_w002b_NNPDF31.dat","w"); 
    aq10=fopen("XSecSoftPBP_BSG20orig_w002b_NNPDF31.dat","w");             
    aq11=fopen("XSecHard_BSG20orig_w002b_NNPDF31.dat","w"); 
    ...
    double Stpp,Stpbarp,Selpp,Selpbarp,Sdiffpp,Sdiffpbarp,Seikpp,Seikpbarp,Ssoftpp,Ssoftpbarp,Shard;
     ...
     do{
      ...
      aq1 = fopen("XSecTotPP_BSG20orig_w002b_NNPDF31.dat","r");
      aq2 = fopen("XSecTotPBP_BSG20orig_w002b_NNPDF31.dat","r");
      aq3 = fopen("XSecElPP_BSG20orig_w002b_NNPDF31.dat","r");
      aq4 = fopen("XSecElPBP_BSG20orig_w002b_NNPDF31.dat","r");
      aq5 = fopen("XSecDiffPP_BSG20orig_w002b_NNPDF31.dat","r"); 
      aq6 = fopen("XSecDiffPBP_BSG20orig_w002b_NNPDF31.dat","r");  
      aq7 = fopen("XSecEikPP_BSG20orig_w002b_NNPDF31.dat","r"); 
      aq8 = fopen("XSecEikPBP_BSG20orig_w002b_NNPDF31.dat","r"); 
      aq9 = fopen("XSecSoftPP_BSG20orig_w002b_NNPDF31.dat","r"); 
      aq10 = fopen("XSecSoftPBP_BSG20orig_w002b_NNPDF31.dat","r");             
      aq11 = fopen("XSecHard_BSG20orig_w002b_NNPDF31.dat","r");                   
