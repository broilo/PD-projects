...
------------------------------------------------------------------------
 ...
 root -l -q /usr/lib/x86_64-linux-gnu/libgsl.so /usr/lib/x86_64-linux-gnu/libgslcblas.so BSG20orig_w002b_MMHT_member_34.C | cat > BSG20orig_w002b_MMHT_member_34.min
 
  MMHT_member_34 -> See: https://lhapdf.hepforge.org/index.html
   ---------------------------------------------------------------------
...
//----------------------------------------------------------------------
//QCD cross section - analytical parametrization for MMHT_member_34
//----------------------------------------------------------------------
...
const double b1=1.03846e+02;
const double b2=3.16961e-01;
const double b3=3.73717e-01;
const double b4=2.88838e+00;
const double b5=1.09232e-01;
const double b6=1.29218e+00;
const double b7=1.62893e+00;
const double b8=-2.16394e+00;
const double b9=6.62651e-01;
const double b10=1.05991e+00; 
/*
 NO.   NAME      VALUE            ERROR          SIZE      DERIVATIVE 
   1  b1           1.03846e+02   6.19914e+00   1.39549e-02  -3.96963e-01
   2  b2           3.16961e-01   1.05257e-01   1.39562e-03  -2.00184e+01
   3  b3           3.73717e-01   3.83228e-03   3.17173e-05  -1.64961e+02
   4  b4           2.88838e+00   2.94327e-02  -3.58109e-04  -6.99600e+01
   5  b5           1.09232e-01   4.48630e-02   2.07683e-04  -1.06351e+01
   6  b6           1.29218e+00   1.19673e-01   1.76507e-03  -6.38794e+00
   7  b7           1.62893e+00   1.84783e-01  -2.40219e-03  -8.81879e+00
   8  b8          -2.16394e+00   2.17845e+00  -1.89581e-02  -1.72236e-01
   9  b9           6.62651e-01   8.20619e-01   2.16984e-02   9.28909e-01
  10  b10          1.05991e+00   1.15211e+00  -3.28388e-02   5.33215e-01
*/
//----------------------------------------------------------------------
/*
                              Analysis 
...
/* ---> desenhando um miniframe em um pad dentro do canvas canv1 <--- */
    ...
    grSigTotPP->Draw("csame");
      ...
      canv1->SaveAs("XSECtot_BSG20orig_w002b_MMHT_member_34.eps");    
}
//----------------------------------------------------------------------
...
/* ---> desenhando um miniframe em um pad dentro do canvas canv1 <--- */
    ...
    grSigElPP->Draw("csame");
      ...
      canv1->SaveAs("XSECel_BSG20orig_w002b_MMHT_member_34.eps");    
}
//----------------------------------------------------------------------
...
// Plotting SigDiff data    
    ...
    for(int i=0;i<NPaq3;i++)     
     ...
     fclose(aq8);
      ...
      canv1->SaveAs("XSECdiff_BSG20orig_w002b_MMHT_member_34.eps");
}
//----------------------------------------------------------------------
...
{   
      ...
      canv1->SaveAs("XSECeik_BSG20orig_w002b_MMHT_member_34.eps");    
}
...
{   
      ...
      canv1->SaveAs("XSECsofthard_BSG20orig_w002b_MMHT_member_34.eps");    
}
...
//----------------------------------------------------------------------
void BSG20orig_w002b_MMHT_member_34()
{
    /******************************************/
    //time control - start
...
//----------------------------------------------------------------------
   //calculates total, elastic, diff and eik xsection, creating files to make the plots
    ...
    aq1=fopen("XSecTotPP_BSG20orig_w002b_MMHT_member_34.dat","w"); 
    aq2=fopen("XSecTotPBP_BSG20orig_w002b_MMHT_member_34.dat","w");
    aq3=fopen("XSecElPP_BSG20orig_w002b_MMHT_member_34.dat","w"); 
    aq4=fopen("XSecElPBP_BSG20orig_w002b_MMHT_member_34.dat","w");
    aq5=fopen("XSecDiffPP_BSG20orig_w002b_MMHT_member_34.dat","w"); 
    aq6=fopen("XSecDiffPBP_BSG20orig_w002b_MMHT_member_34.dat","w");  
    aq7=fopen("XSecEikPP_BSG20orig_w002b_MMHT_member_34.dat","w"); 
    aq8=fopen("XSecEikPBP_BSG20orig_w002b_MMHT_member_34.dat","w"); 
    aq9=fopen("XSecSoftPP_BSG20orig_w002b_MMHT_member_34.dat","w"); 
    aq10=fopen("XSecSoftPBP_BSG20orig_w002b_MMHT_member_34.dat","w");             
    aq11=fopen("XSecHard_BSG20orig_w002b_MMHT_member_34.dat","w"); 
    ...
    double Stpp,Stpbarp,Selpp,Selpbarp,Sdiffpp,Sdiffpbarp,Seikpp,Seikpbarp,Ssoftpp,Ssoftpbarp,Shard;
     ...
     do{
      ...
      aq1 = fopen("XSecTotPP_BSG20orig_w002b_MMHT_member_34.dat","r");
      aq2 = fopen("XSecTotPBP_BSG20orig_w002b_MMHT_member_34.dat","r");
      aq3 = fopen("XSecElPP_BSG20orig_w002b_MMHT_member_34.dat","r");
      aq4 = fopen("XSecElPBP_BSG20orig_w002b_MMHT_member_34.dat","r");
      aq5 = fopen("XSecDiffPP_BSG20orig_w002b_MMHT_member_34.dat","r"); 
      aq6 = fopen("XSecDiffPBP_BSG20orig_w002b_MMHT_member_34.dat","r");  
      aq7 = fopen("XSecEikPP_BSG20orig_w002b_MMHT_member_34.dat","r"); 
      aq8 = fopen("XSecEikPBP_BSG20orig_w002b_MMHT_member_34.dat","r"); 
      aq9 = fopen("XSecSoftPP_BSG20orig_w002b_MMHT_member_34.dat","r"); 
      aq10 = fopen("XSecSoftPBP_BSG20orig_w002b_MMHT_member_34.dat","r");             
      aq11 = fopen("XSecHard_BSG20orig_w002b_MMHT_member_34.dat","r");                   
