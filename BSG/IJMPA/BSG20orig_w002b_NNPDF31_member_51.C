...
------------------------------------------------------------------------
 ...
 root -l -q /usr/lib/x86_64-linux-gnu/libgsl.so /usr/lib/x86_64-linux-gnu/libgslcblas.so BSG20orig_w002b_NNPDF31_member_51.C | cat > BSG20orig_w002b_NNPDF31_member_51.min
 
  NNPDF31_member_51 -> See: https://lhapdf.hepforge.org/index.html
   ---------------------------------------------------------------------
...
//----------------------------------------------------------------------
//QCD cross section - analytical parametrization for NNPDF31_member_51
//----------------------------------------------------------------------
...
const double b1=1.03888e+02;
const double b2=1.58828e-02;
const double b3=1.26917e+00;
const double b4=2.02550e+00;
const double b5=-2.71141e+00;
const double b6=7.55530e-01;
const double b7=1.77154e+00;
const double b8=1.04424e+00;
const double b9=1.01997e+00;
const double b10=1.70387e+00; 
/*
 NO.   NAME      VALUE            ERROR          SIZE      DERIVATIVE 
   1  b1           1.03888e+02   1.04682e+00  -2.82220e-03  -2.80974e+00
   2  b2           1.58828e-02   2.49164e-03  -1.92478e-04  -3.96259e+03
   3  b3           1.26917e+00   1.58179e-03   1.02056e-04  -5.67106e+02
   4  b4           2.02550e+00   6.59390e-03   5.00990e-04  -7.86268e+02
   5  b5          -2.71141e+00   2.89655e-01   1.18563e-02  -1.80996e+01
   6  b6           7.55530e-01   2.39425e-02   1.80732e-03   3.10342e+02
   7  b7           1.77154e+00   3.35115e-02   7.52270e-04   2.47723e+02
   8  b8           1.04424e+00   3.76170e-02   2.90888e-03  -9.97621e+01
   9  b9           1.01997e+00   8.60141e-03   6.26912e-04  -6.94797e+02
  10  b10          1.70387e+00   5.03191e-03   1.55252e-04  -7.94468e+02
*/
//----------------------------------------------------------------------
/*
                              Analysis 
...
/* ---> desenhando um miniframe em um pad dentro do canvas canv1 <--- */
    ...
    grSigTotPP->Draw("csame");
      ...
      canv1->SaveAs("XSECtot_BSG20orig_w002b_NNPDF31_member_51.eps");    
}
//----------------------------------------------------------------------
...
/* ---> desenhando um miniframe em um pad dentro do canvas canv1 <--- */
    ...
    grSigElPP->Draw("csame");
      ...
      canv1->SaveAs("XSECel_BSG20orig_w002b_NNPDF31_member_51.eps");    
}
//----------------------------------------------------------------------
...
// Plotting SigDiff data    
    ...
    for(int i=0;i<NPaq3;i++)     
     ...
     fclose(aq8);
      ...
      canv1->SaveAs("XSECdiff_BSG20orig_w002b_NNPDF31_member_51.eps");
}
//----------------------------------------------------------------------
...
{   
      ...
      canv1->SaveAs("XSECeik_BSG20orig_w002b_NNPDF31_member_51.eps");    
}
...
{   
      ...
      canv1->SaveAs("XSECsofthard_BSG20orig_w002b_NNPDF31_member_51.eps");    
}
...
//----------------------------------------------------------------------
void BSG20orig_w002b_NNPDF31_member_51()
{
    /******************************************/
    //time control - start
...
//----------------------------------------------------------------------
   //calculates total, elastic, diff and eik xsection, creating files to make the plots
    ...
    aq1=fopen("XSecTotPP_BSG20orig_w002b_NNPDF31_member_51.dat","w"); 
    aq2=fopen("XSecTotPBP_BSG20orig_w002b_NNPDF31_member_51.dat","w");
    aq3=fopen("XSecElPP_BSG20orig_w002b_NNPDF31_member_51.dat","w"); 
    aq4=fopen("XSecElPBP_BSG20orig_w002b_NNPDF31_member_51.dat","w");
    aq5=fopen("XSecDiffPP_BSG20orig_w002b_NNPDF31_member_51.dat","w"); 
    aq6=fopen("XSecDiffPBP_BSG20orig_w002b_NNPDF31_member_51.dat","w");  
    aq7=fopen("XSecEikPP_BSG20orig_w002b_NNPDF31_member_51.dat","w"); 
    aq8=fopen("XSecEikPBP_BSG20orig_w002b_NNPDF31_member_51.dat","w"); 
    aq9=fopen("XSecSoftPP_BSG20orig_w002b_NNPDF31_member_51.dat","w"); 
    aq10=fopen("XSecSoftPBP_BSG20orig_w002b_NNPDF31_member_51.dat","w");             
    aq11=fopen("XSecHard_BSG20orig_w002b_NNPDF31_member_51.dat","w"); 
    ...
    double Stpp,Stpbarp,Selpp,Selpbarp,Sdiffpp,Sdiffpbarp,Seikpp,Seikpbarp,Ssoftpp,Ssoftpbarp,Shard;
     ...
     do{
      ...
      aq1 = fopen("XSecTotPP_BSG20orig_w002b_NNPDF31_member_51.dat","r");
      aq2 = fopen("XSecTotPBP_BSG20orig_w002b_NNPDF31_member_51.dat","r");
      aq3 = fopen("XSecElPP_BSG20orig_w002b_NNPDF31_member_51.dat","r");
      aq4 = fopen("XSecElPBP_BSG20orig_w002b_NNPDF31_member_51.dat","r");
      aq5 = fopen("XSecDiffPP_BSG20orig_w002b_NNPDF31_member_51.dat","r"); 
      aq6 = fopen("XSecDiffPBP_BSG20orig_w002b_NNPDF31_member_51.dat","r");  
      aq7 = fopen("XSecEikPP_BSG20orig_w002b_NNPDF31_member_51.dat","r"); 
      aq8 = fopen("XSecEikPBP_BSG20orig_w002b_NNPDF31_member_51.dat","r"); 
      aq9 = fopen("XSecSoftPP_BSG20orig_w002b_NNPDF31_member_51.dat","r"); 
      aq10 = fopen("XSecSoftPBP_BSG20orig_w002b_NNPDF31_member_51.dat","r");             
      aq11 = fopen("XSecHard_BSG20orig_w002b_NNPDF31_member_51.dat","r");                   
