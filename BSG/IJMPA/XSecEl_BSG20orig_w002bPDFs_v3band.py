...
px31,py31 = np.loadtxt("XSecElPP_BSG20orig_w002b_NNPDF31_member_38.dat", usecols=(0,1), unpack=True)
px32,py32 = np.loadtxt("XSecElPP_BSG20orig_w002b_NNPDF31_member_51.dat", usecols=(0,1), unpack=True)

px4,py4 = np.loadtxt("XSecElPBP_BSG20orig_w002b_NNPDF31.dat", usecols=(0,1), unpack=True)
px41,py41 = np.loadtxt("XSecElPBP_BSG20orig_w002b_NNPDF31_member_38.dat", usecols=(0,1), unpack=True)
px42,py42 = np.loadtxt("XSecElPBP_BSG20orig_w002b_NNPDF31_member_51.dat", usecols=(0,1), unpack=True)

px5,py5 = np.loadtxt("XSecElPP_BSG20orig_w002b_MMHT.dat", usecols=(0,1), unpack=True)
px51,py51 = np.loadtxt("XSecElPP_BSG20orig_w002b_MMHT_member_34.dat", usecols=(0,1), unpack=True)
px52,py52 = np.loadtxt("XSecElPP_BSG20orig_w002b_MMHT_member_39.dat", usecols=(0,1), unpack=True)

px6,py6 = np.loadtxt("XSecElPBP_BSG20orig_w002b_MMHT.dat", usecols=(0,1), unpack=True)
px61,py61 = np.loadtxt("XSecElPBP_BSG20orig_w002b_MMHT_member_34.dat", usecols=(0,1), unpack=True)
px62,py62 = np.loadtxt("XSecElPBP_BSG20orig_w002b_MMHT_member_39.dat", usecols=(0,1), unpack=True)
...
plt.savefig("XSecEl_BSG20orig_w002bPDFs_v3band.pdf")
#plt.show()
