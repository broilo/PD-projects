...
------------------------------------------------------------------------
   *** Main characteristics ***
	...
	> Calculates Total, Elastic and Diff xsec pp and pbp
 ...
 root -l -q /usr/lib/x86_64-linux-gnu/libgsl.so /usr/lib/x86_64-linux-gnu/libgslcblas.so BSG20orig_w002teste2.C | cat > BSG20orig_w002teste2.min
...
/* ---> desenhando um miniframe em um pad dentro do canvas canv1 <--- */
    ...
    grSigTotPP->Draw("csame");
      ...
      canv1->SaveAs("XSECtot_BSG20orig_w002teste2.eps");    
}
//----------------------------------------------------------------------
...
/* ---> desenhando um miniframe em um pad dentro do canvas canv1 <--- */
    ...
    grSigElPP->Draw("csame");
      ...
      canv1->SaveAs("XSECel_BSG20orig_w002teste2.eps");    
}
//----------------------------------------------------------------------
...
// Plotting SigDiff data    
    ...
    for(int i=0;i<NPaq3;i++)     
     ...
     fclose(aq8);
      ...
      canv1->SaveAs("XSECdiff_BSG20orig_w002teste2.eps");
...
void PlotEikXSec(double *Wcm,double *XSecEikpp,double *XSecEikpbp,int npfit)
{
      ...
      canv1->SaveAs("XSECeik_BSG20orig_w002teste2.eps");    
}
...
//    gMinuit->mnexcm("MIGRAD", arglist ,1,ierflg);   
  ...
  cout << " Status of covariance matrix = " << icstat << "\n\n";  
   ...
   for (int i=0; i<numpar; i++)
    ...
    TF1 SigEikPP("SigEikPP",KerThings,Wmin,Wmax,8);
    ...
    TF1 SigEikPBARP("SigEikPBARP",KerThings,Wmin,Wmax,8);
...
//----------------------------------------------------------------------
   //calculates total xsection and elastic xsection, creating files to make the plots
    ...
    aq1=fopen("XSecTotPP_BSG20orig_w002teste2.dat","w"); 
    aq2=fopen("XSecTotPBP_BSG20orig_w002teste2.dat","w");
    aq3=fopen("XSecElPP_BSG20orig_w002teste2.dat","w"); 
    aq4=fopen("XSecElPBP_BSG20orig_w002teste2.dat","w");
    aq5=fopen("XSecDiffPP_BSG20orig_w002teste2.dat","w"); 
    aq6=fopen("XSecDiffPBP_BSG20orig_w002teste2.dat","w");  
    aq7=fopen("XSecEikPP_BSG20orig_w002teste2.dat","w"); 
    aq8=fopen("XSecEikPBP_BSG20orig_w002teste2.dat","w");      
    ...
    double Ecm;
    double Stpp,Stpbarp,Selpp,Selpbarp,Sdiffpp,Sdiffpbarp,Seikpp,Seikpbarp;
     ...
     do{
      ...
      aq1 = fopen("XSecTotPP_BSG20orig_w002teste2.dat","r");
      aq2 = fopen("XSecTotPBP_BSG20orig_w002teste2.dat","r");
      aq3 = fopen("XSecElPP_BSG20orig_w002teste2.dat","r");
      aq4 = fopen("XSecElPBP_BSG20orig_w002teste2.dat","r");
      aq5 = fopen("XSecDiffPP_BSG20orig_w002teste2.dat","r"); 
      aq6 = fopen("XSecDiffPBP_BSG20orig_w002teste2.dat","r");  
      aq7 = fopen("XSecEikPP_BSG20orig_w002teste2.dat","r"); 
      aq8 = fopen("XSecEikPBP_BSG20orig_w002teste2.dat","r");                    
      
      const int npfit=108;
      double Wcm[npfit],XSecTOTpp[npfit],XSecTOTpbp[npfit],XSecElpp[npfit],XSecElpbp[npfit],XSecDiffpp[npfit],XSecDiffpbp[npfit],XSecEikpp[npfit],XSecEikpbp[npfit];       
