...
------------------------------------------------------------------------
 ...
 root -l -q /usr/lib/x86_64-linux-gnu/libgsl.so /usr/lib/x86_64-linux-gnu/libgslcblas.so BSG20orig_w002b_MMHT.C | cat > BSG20orig_w002b_MMHT.min
...
//----------------------------------------------------------------------
//QCD cross section - analytical parametrization for CTEQ6L
//----------------------------------------------------------------------
...
const double b1=9.71736e+01;
const double b2=2.30611e-01;
const double b3=3.68567e-01;
const double b4=2.88920e+00;
const double b5=5.31509e-02;
const double b6=1.34562e+00;
const double b7=1.73674e+00;
const double b8=8.56073e+00;
const double b9=-9.39626e-01;
const double b10=1.64482e+00;
/*
   1  b1           9.71736e+01   2.42818e+00   1.44776e-02   2.65431e-01
   2  b2           2.30611e-01   5.36326e-03   1.83279e-04   2.34817e+01
   3  b3           3.68567e-01   5.21841e-04  -1.46867e-05   1.09091e+02
   4  b4           2.88920e+00   2.02841e-03  -7.21652e-05   4.35361e+01
   5  b5           5.31509e-02   7.10156e-03  -1.06371e-04   1.31210e+02
   6  b6           1.34562e+00   7.47020e-03   4.47600e-05   4.04412e+01
   7  b7           1.73674e+00   1.14786e-02   1.79234e-04   5.41413e+01
   8  b8           8.56073e+00   2.55331e+00   1.05573e-01  -1.29943e-02
   9  b9          -9.39626e-01   4.86825e-01  -1.89720e-02  -1.35718e-01
  10  b10          1.64482e+00   1.59741e+00   8.32559e-02  -2.43743e-02
*/
/*
const double b1=95.284;
const double b2=0.37224;
const double b3=0.59990;
const double b4=2.4959;
const double b5=-0.25543e-5;
const double b6=14.281;
const double b7=0.28071;
const double b8=0.90856e-1;
const double b9=4.2904;
const double b10=0.67342;
*/
//----------------------------------------------------------------------
/*
                              Analysis 
...
/* ---> desenhando um miniframe em um pad dentro do canvas canv1 <--- */
    ...
    grSigTotPP->Draw("csame");
      ...
      canv1->SaveAs("XSECtot_BSG20orig_w002b_MMHT.eps");    
}
//----------------------------------------------------------------------
...
/* ---> desenhando um miniframe em um pad dentro do canvas canv1 <--- */
    ...
    grSigElPP->Draw("csame");
      ...
      canv1->SaveAs("XSECel_BSG20orig_w002b_MMHT.eps");    
}
//----------------------------------------------------------------------
...
// Plotting SigDiff data    
    ...
    for(int i=0;i<NPaq3;i++)     
     ...
     fclose(aq8);
      ...
      canv1->SaveAs("XSECdiff_BSG20orig_w002b_MMHT.eps");
}
//----------------------------------------------------------------------
...
{   
      ...
      canv1->SaveAs("XSECeik_BSG20orig_w002b_MMHT.eps");    
}
...
{   
      ...
      canv1->SaveAs("XSECsofthard_BSG20orig_w002b_MMHT.eps");    
}
...
//----------------------------------------------------------------------
   //calculates total, elastic, diff and eik xsection, creating files to make the plots
    ...
    aq1=fopen("XSecTotPP_BSG20orig_w002b_MMHT.dat","w"); 
    aq2=fopen("XSecTotPBP_BSG20orig_w002b_MMHT.dat","w");
    aq3=fopen("XSecElPP_BSG20orig_w002b_MMHT.dat","w"); 
    aq4=fopen("XSecElPBP_BSG20orig_w002b_MMHT.dat","w");
    aq5=fopen("XSecDiffPP_BSG20orig_w002b_MMHT.dat","w"); 
    aq6=fopen("XSecDiffPBP_BSG20orig_w002b_MMHT.dat","w");  
    aq7=fopen("XSecEikPP_BSG20orig_w002b_MMHT.dat","w"); 
    aq8=fopen("XSecEikPBP_BSG20orig_w002b_MMHT.dat","w"); 
    aq9=fopen("XSecSoftPP_BSG20orig_w002b_MMHT.dat","w"); 
    aq10=fopen("XSecSoftPBP_BSG20orig_w002b_MMHT.dat","w");             
    aq11=fopen("XSecHard_BSG20orig_w002b_MMHT.dat","w"); 
    ...
    double Stpp,Stpbarp,Selpp,Selpbarp,Sdiffpp,Sdiffpbarp,Seikpp,Seikpbarp,Ssoftpp,Ssoftpbarp,Shard;
     ...
     do{
      ...
      aq1 = fopen("XSecTotPP_BSG20orig_w002b_MMHT.dat","r");
      aq2 = fopen("XSecTotPBP_BSG20orig_w002b_MMHT.dat","r");
      aq3 = fopen("XSecElPP_BSG20orig_w002b_MMHT.dat","r");
      aq4 = fopen("XSecElPBP_BSG20orig_w002b_MMHT.dat","r");
      aq5 = fopen("XSecDiffPP_BSG20orig_w002b_MMHT.dat","r"); 
      aq6 = fopen("XSecDiffPBP_BSG20orig_w002b_MMHT.dat","r");  
      aq7 = fopen("XSecEikPP_BSG20orig_w002b_MMHT.dat","r"); 
      aq8 = fopen("XSecEikPBP_BSG20orig_w002b_MMHT.dat","r"); 
      aq9 = fopen("XSecSoftPP_BSG20orig_w002b_MMHT.dat","r"); 
      aq10 = fopen("XSecSoftPBP_BSG20orig_w002b_MMHT.dat","r");             
      aq11 = fopen("XSecHard_BSG20orig_w002b_MMHT.dat","r");                   
