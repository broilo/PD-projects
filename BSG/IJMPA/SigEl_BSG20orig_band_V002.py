...
px3,py3 = np.loadtxt("SigElpp_BSG20orig_SigEl_band1_V002.dat", usecols=(0,1), unpack=True)

px4,py4 = np.loadtxt("SigElpp_BSG20orig_SigEl_band2_V002.dat", usecols=(0,1), unpack=True)

px5,py5 = np.loadtxt("SigElpbp_BSG20orig_SigEl_band1_V002.dat", usecols=(0,1), unpack=True)

px6,py6 = np.loadtxt("SigElpbp_BSG20orig_SigEl_band2_V002.dat", usecols=(0,1), unpack=True)
...
plt.savefig("SigEl_BSG20orig_band_V002.eps")
plt.show()
