...
px3,py3 = np.loadtxt("XSecElPP_BSG20orig_w002b_CTEQ6L.dat", usecols=(0,1), unpack=True)

px4,py4 = np.loadtxt("XSecElPBP_BSG20orig_w002b_CTEQ6L.dat", usecols=(0,1), unpack=True)
...
plt.savefig("XSecEl_BSG20orig_w002bPDFs.eps")
#plt.show()
