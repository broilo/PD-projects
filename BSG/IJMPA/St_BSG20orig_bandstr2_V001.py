...
px3,py3 = np.loadtxt("Stpp_BSG20orig_band1str2_V001.dat", usecols=(0,1), unpack=True)

px4,py4 = np.loadtxt("Stpp_BSG20orig_band2str2_V001.dat", usecols=(0,1), unpack=True)

px5,py5 = np.loadtxt("Stpbp_BSG20orig_band1str2_V001.dat", usecols=(0,1), unpack=True)

px6,py6 = np.loadtxt("Stpbp_BSG20orig_band2str2_V001.dat", usecols=(0,1), unpack=True)
...
plt.savefig("St_BSG20orig_bandstr2_V001.eps")
plt.show()
