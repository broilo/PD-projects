...
------------------------------------------------------------------------
 ...
 root -l -q /usr/lib/x86_64-linux-gnu/libgsl.so /usr/lib/x86_64-linux-gnu/libgslcblas.so BSG20orig_w002c.C | cat > BSG20orig_w002c.min
...
/* ---> desenhando um miniframe em um pad dentro do canvas canv1 <--- */
    ...
    grSigTotPP->Draw("csame");
      ...
      canv1->SaveAs("XSECtot_BSG20orig_w002c.eps");    
}
//----------------------------------------------------------------------
...
/* ---> desenhando um miniframe em um pad dentro do canvas canv1 <--- */
    ...
    grSigElPP->Draw("csame");
      ...
      canv1->SaveAs("XSECel_BSG20orig_w002c.eps");    
}
//----------------------------------------------------------------------
...
// Plotting SigDiff data    
    ...
    for(int i=0;i<NPaq3;i++)     
     ...
     fclose(aq8);
      ...
      canv1->SaveAs("XSECdiff_BSG20orig_w002c.eps");
}
//----------------------------------------------------------------------
...
{   
      ...
      canv1->SaveAs("XSECeik_BSG20orig_w002c.eps");    
}
//----------------------------------------------------------------------
...
//----------------------------------------------------------------------
   //calculates total, elastic, diff and eik xsection, creating files to make the plots
    ...
    aq1=fopen("XSecTotPP_BSG20orig_w002c.dat","w"); 
    aq2=fopen("XSecTotPBP_BSG20orig_w002c.dat","w");
    aq3=fopen("XSecElPP_BSG20orig_w002c.dat","w"); 
    aq4=fopen("XSecElPBP_BSG20orig_w002c.dat","w");
    aq5=fopen("XSecDiffPP_BSG20orig_w002c.dat","w"); 
    aq6=fopen("XSecDiffPBP_BSG20orig_w002c.dat","w");  
    aq7=fopen("XSecEikPP_BSG20orig_w002c.dat","w"); 
    aq8=fopen("XSecEikPBP_BSG20orig_w002c.dat","w");      
    ...
    double Stpp,Stpbarp,Selpp,Selpbarp,Sdiffpp,Sdiffpbarp,Seikpp,Seikpbarp;
     ...
     do{
      ...
      aq1 = fopen("XSecTotPP_BSG20orig_w002c.dat","r");
      aq2 = fopen("XSecTotPBP_BSG20orig_w002c.dat","r");
      aq3 = fopen("XSecElPP_BSG20orig_w002c.dat","r");
      aq4 = fopen("XSecElPBP_BSG20orig_w002c.dat","r");
      aq5 = fopen("XSecDiffPP_BSG20orig_w002c.dat","r"); 
      aq6 = fopen("XSecDiffPBP_BSG20orig_w002c.dat","r");  
      aq7 = fopen("XSecEikPP_BSG20orig_w002c.dat","r"); 
      aq8 = fopen("XSecEikPBP_BSG20orig_w002c.dat","r");                    
