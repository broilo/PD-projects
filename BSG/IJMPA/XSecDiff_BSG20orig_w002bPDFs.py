...
px3,py3 = np.loadtxt("XSecDiffPP_BSG20orig_w002b_CTEQ6L.dat", usecols=(0,1), unpack=True)

px4,py4 = np.loadtxt("XSecDiffPBP_BSG20orig_w002b_CTEQ6L.dat", usecols=(0,1), unpack=True)
...
handle_curve_CTE6L = mlines.Line2D([],[],color='red',linestyle='dashed', linewidth=1.25, label=r'CTEQ6L')
...
plt.savefig("XSecDiff_BSG20orig_w002bPDFs.eps")
#plt.show()
