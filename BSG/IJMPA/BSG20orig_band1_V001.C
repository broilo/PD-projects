 ...
 *** Bandas de incerteza ***
 ...
 root -l -q /usr/lib/x86_64-linux-gnu/libgsl.so /usr/lib/x86_64-linux-gnu/libgslcblas.so BSG20orig_band1_V001.C | cat > BSG20orig_band1_V001.min
...
/* ---> desenhando um miniframe em um pad dentro do canvas canv1 <--- */
    ...
    grSigPP_Eik->Draw("csame");
      ...
      canv1->SaveAs("St_BSG20orig_band1_V001.eps");    
}
//----------------------------------------------------------------------
...
/*    
   1  Sig0         7.35489e+01   3.46423e-01  -0.00000e+00   5.12825e-07
   2  A1           1.30225e+01   7.75315e-01   0.00000e+00  -1.00426e-07
   3  A2           1.72119e+01   4.11404e-01   0.00000e+00   3.57866e-10
   4  B            7.55541e-01   2.37580e-02   0.00000e+00  -1.17997e-06
*/
        /*******************************************************/
    //Total XSection - pp
...
//----------------------------------------------------------------------
   //calculates total xsection and rho, creating files to make the plots
    ...
    aq1=fopen("Stpp_BSG20orig_band1_V001.dat","w"); 
    aq2=fopen("Stpbp_BSG20orig_band1_V001.dat","w"); 
    ...
    double sigpp,sigpbarp;
     ...
     do{
      ...
      aq1 = fopen("Stpp_BSG20orig_band1_V001.dat","r");
      aq2 = fopen("Stpbp_BSG20orig_band1_V001.dat","r");
