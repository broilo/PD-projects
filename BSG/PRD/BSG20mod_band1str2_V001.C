 ...
 *** Bandas de incerteza ***
 ...
 root -l -q /usr/lib/x86_64-linux-gnu/libgsl.so /usr/lib/x86_64-linux-gnu/libgslcblas.so BSG20mod_band1str2_V001.C | cat > BSG20mod_band1str2_V001.min
   ...
   Last update: 7/fev/2020 (Pelotas, RS, Brazil)
...
/* ---> desenhando um miniframe em um pad dentro do canvas canv1 <--- */
    ...
    grSigPP_Eik->Draw("csame");
      ...
      canv1->SaveAs("St_BSG20mod_band1str2_V001.eps");    
}
//----------------------------------------------------------------------
...
//----------------------------------------------------------------------
   //calculates total xsection and rho, creating files to make the plots
    ...
    aq1=fopen("Stpp_BSG20mod_band1str2_V001.dat","w"); 
    aq2=fopen("Stpbp_BSG20mod_band1str2_V001.dat","w"); 
    ...
    double sigpp,sigpbarp;
     ...
     do{
      ...
      aq1 = fopen("Stpp_BSG20mod_band1str2_V001.dat","r");
      aq2 = fopen("Stpbp_BSG20mod_band1str2_V001.dat","r");
