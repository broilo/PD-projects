 ...
 *** Bandas de incerteza ***
 ...
 root -l -q /usr/lib/x86_64-linux-gnu/libgsl.so /usr/lib/x86_64-linux-gnu/libgslcblas.so BSG20mod_band2_V002.C | cat > BSG20mod_band2_V002.min
...
/* ---> desenhando um miniframe em um pad dentro do canvas canv1 <--- */
    ...
    grSigPP_Eik->Draw("csame");
      ...
      canv1->SaveAs("St_BSG20mod_band2_V002.eps");    
}
//----------------------------------------------------------------------
...
//    gMinuit->mnexcm("MIGRAD", arglist ,1,ierflg);   
  ...
  cout << " Status of covariance matrix = " << icstat << "\n\n";  
   ...
   for (int i=0; i<numpar; i++)
    ...
    double Sig0=1.00260e+02;//outpar[1];
    double A1=2.03048e+01;//outpar[2];
    double del1=0.5;//outpar[3];
    double A2=2.61103e+01;//outpar[3];  
    double del2=0.5;//outpar[5];
    double B=1.2;//outpar[3];
    
   /*
   1  w            1.05062e+00   3.97101e-02   1.52946e-06   4.58470e-03
   2  Sig0         1.00260e+02   2.31002e+00   7.96997e-05   1.47472e-06
   3  A1           2.03048e+01   1.15241e+00   3.15793e-05   1.00010e-04
   4  A2           2.61103e+01   9.48606e-01   3.25095e-05  -1.83167e-06
   */     
    /*******************************************************/
    //Total XSection - pp
...
//----------------------------------------------------------------------
   //calculates total xsection and rho, creating files to make the plots
    ...
    aq1=fopen("Stpp_BSG20mod_band2_V002.dat","w"); 
    aq2=fopen("Stpbp_BSG20mod_band2_V002.dat","w"); 
    ...
    double sigpp,sigpbarp;
     ...
     do{
      ...
      aq1 = fopen("Stpp_BSG20mod_band2_V002.dat","r");
      aq2 = fopen("Stpbp_BSG20mod_band2_V002.dat","r");
