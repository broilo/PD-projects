...
xf11,yf11 = np.loadtxt("SigSDpp_BSG20mod_Diffs_V002za.dat", usecols=(0,1), unpack=True)

xf12,yf12 = np.loadtxt("SigSDpp_BSG20mod_Diffs_V002zb.dat", usecols=(0,1), unpack=True)

xf13,yf13 = np.loadtxt("SigSDpp_BSG20mod_Diffs_V002zc.dat", usecols=(0,1), unpack=True)

xf21,yf21 = np.loadtxt("SigSDpbp_BSG20mod_Diffs_V002za.dat", usecols=(0,1), unpack=True)

xf22,yf22 = np.loadtxt("SigSDpbp_BSG20mod_Diffs_V002zb.dat", usecols=(0,1), unpack=True)

xf23,yf23 = np.loadtxt("SigSDpbp_BSG20mod_Diffs_V002zc.dat", usecols=(0,1), unpack=True)

xf31,yf31 = np.loadtxt("SigDDpp_BSG20mod_Diffs_V002za.dat", usecols=(0,1), unpack=True)

xf32,yf32 = np.loadtxt("SigDDpp_BSG20mod_Diffs_V002zb.dat", usecols=(0,1), unpack=True)

xf33,yf33 = np.loadtxt("SigDDpp_BSG20mod_Diffs_V002zc.dat", usecols=(0,1), unpack=True)

xf41,yf41 = np.loadtxt("SigDDpbp_BSG20mod_Diffs_V002za.dat", usecols=(0,1), unpack=True)

xf42,yf42 = np.loadtxt("SigDDpbp_BSG20mod_Diffs_V002zb.dat", usecols=(0,1), unpack=True)

xf43,yf43 = np.loadtxt("SigDDpbp_BSG20mod_Diffs_V002zc.dat", usecols=(0,1), unpack=True)
...
plt.savefig("SigDiffs_BSG20mod_band_V002zabc.eps")
plt.show()
