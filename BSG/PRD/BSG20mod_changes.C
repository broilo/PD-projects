...
------------------------------------------------------------------------
   *** Main characteristics ***
	...
	> Calculates soft and hard components of St pp e pbp
 ...
 Obs3: PDF: CT14
 Obs4: Free: w, Sig0, A1, del1, A2, del2
 ...
 *** Bandas de incerteza ***
 ...
 root -l -q /usr/lib/x86_64-linux-gnu/libgsl.so /usr/lib/x86_64-linux-gnu/libgslcblas.so BSG20mod_changes.C | cat > BSG20mod_changes.min
   ...
   Last update: 28/mar/2020 (Pelotas, RS, Brazil)
...
double KerForward(double *x,double *par)
{
    ...
    //pp
    double SigSoftPP=0.;//(Sig0+SigR1-SigR2);
    //pbp
    double SigSoftPBP=0.;//(Sig0+SigR1+SigR2);
    /*******************************************************/
    //SigEik
    /*******************************************************/
    //pp
...
/* ---> desenhando um miniframe em um pad dentro do canvas canv1 <--- */
    ...
    grSigPP_Eik->Draw("csame");
      ...
      canv1->SaveAs("St_BSG20mod_changes.eps");    
}
//----------------------------------------------------------------------
...
//----------------------------------------------------------------------
   //calculates total xsection and rho, creating files to make the plots
    ...
    aq1=fopen("XSecEikPP_BSG20mod_changes.dat","w"); 
    aq2=fopen("XSecEikPBP_BSG20mod_changes.dat","w"); 
    ...
    double sigpp,sigpbarp;
     ...
     do{
      ...
      aq1 = fopen("XSecEikPP_BSG20mod_changes.dat","r");
      aq2 = fopen("XSecEikPBP_BSG20mod_changes.dat","r");
