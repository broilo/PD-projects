 ...
 *** Bandas de incerteza ***
 ...
 root -l -q /usr/lib/x86_64-linux-gnu/libgsl.so /usr/lib/x86_64-linux-gnu/libgslcblas.so BSG20mod_Diffs_V002za.C | cat > BSG20mod_Diffs_V002za.min
...
// Plotting St data    
    ...
    for(int i=0;i<npdpa8;i++)     
     ...
     fclose(aq8);
      ...
      canv1->SaveAs("SigDiffs_BSG20mod_V002za.eps");    
}
//----------------------------------------------------------------------
...
//----------------------------------------------------------------------
   //calculates total xsection and rho, creating files to make the plots
    ...
    aq1=fopen("SigSDpp_BSG20mod_Diffs_V002za.dat","w"); 
    aq2=fopen("SigSDpbp_BSG20mod_Diffs_V002za.dat","w"); 
    aq3=fopen("SigDDpp_BSG20mod_Diffs_V002za.dat","w"); 
    aq4=fopen("SigDDpbp_BSG20mod_Diffs_V002za.dat","w"); 
    ...
    aq1=fopen("SigSDpp_BSG20mod_Diffs_V002za.dat","r"); 
    aq2=fopen("SigSDpbp_BSG20mod_Diffs_V002za.dat","r"); 
    aq3=fopen("SigDDpp_BSG20mod_Diffs_V002za.dat","r"); 
    aq4=fopen("SigDDpbp_BSG20mod_Diffs_V002za.dat","r");
