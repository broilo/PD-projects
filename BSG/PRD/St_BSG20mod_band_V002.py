...
px3,py3 = np.loadtxt("Stpp_BSG20mod_band1_V002.dat", usecols=(0,1), unpack=True)

px4,py4 = np.loadtxt("Stpp_BSG20mod_band2_V002.dat", usecols=(0,1), unpack=True)

px5,py5 = np.loadtxt("Stpbp_BSG20mod_band1_V002.dat", usecols=(0,1), unpack=True)

px6,py6 = np.loadtxt("Stpbp_BSG20mod_band2_V002.dat", usecols=(0,1), unpack=True)
...
plt.savefig("St_BSG20mod_band_V002.eps")
plt.show()
