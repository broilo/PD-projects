...
px1,py1 = np.loadtxt("Stpp_BSG20mod_SigEl_w002b.dat", usecols=(0,1), unpack=True)

px2,py2 = np.loadtxt("Stpbp_BSG20mod_SigEl_w002b.dat", usecols=(0,1), unpack=True)

px3,py3 = np.loadtxt("Stpp_BSG20mod_SigEl_w002a.dat", usecols=(0,1), unpack=True)

px4,py4 = np.loadtxt("Stpp_BSG20mod_SigEl_w002c.dat", usecols=(0,1), unpack=True)

px5,py5 = np.loadtxt("Stpbp_BSG20mod_SigEl_w002a.dat", usecols=(0,1), unpack=True)

px6,py6 = np.loadtxt("Stpbp_BSG20mod_SigEl_w002c.dat", usecols=(0,1), unpack=True)
...
plt.savefig("SigEl_BSG20mod_band_w002abc.eps")
#plt.show()
