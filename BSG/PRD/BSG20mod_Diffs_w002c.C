...
------------------------------------------------------------------------
 ...
 root -l -q /usr/lib/x86_64-linux-gnu/libgsl.so /usr/lib/x86_64-linux-gnu/libgslcblas.so BSG20mod_Diffs_w002c.C | cat > BSG20mod_Diffs_w002c.min
...
// Plotting St data    
    ...
    for(int i=0;i<npdpa8;i++)     
     ...
     fclose(aq8);
      ...
      canv1->SaveAs("SigDiffs_BSG20mod_w002c.eps");    
}
//----------------------------------------------------------------------
...
//----------------------------------------------------------------------
   //calculates total xsection and rho, creating files to make the plots
    ...
    aq1=fopen("SigSDpp_BSG20mod_Diffs_w002c.dat","w"); 
    aq2=fopen("SigSDpbp_BSG20mod_Diffs_w002c.dat","w"); 
    aq3=fopen("SigDDpp_BSG20mod_Diffs_w002c.dat","w"); 
    aq4=fopen("SigDDpbp_BSG20mod_Diffs_w002c.dat","w"); 
    ...
    aq1=fopen("SigSDpp_BSG20mod_Diffs_w002c.dat","r"); 
    aq2=fopen("SigSDpbp_BSG20mod_Diffs_w002c.dat","r"); 
    aq3=fopen("SigDDpp_BSG20mod_Diffs_w002c.dat","r"); 
    aq4=fopen("SigDDpbp_BSG20mod_Diffs_w002c.dat","r");
